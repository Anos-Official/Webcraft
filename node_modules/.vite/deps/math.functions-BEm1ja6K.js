...
__decorate([nativeOverride.filter((...args) => !Array.isArray(args[0]) && !Array.isArray(args[1]))], MathHelpers, "extractMinAndMaxIndexed", null);
__decorate([nativeOverride.filter((...args) => !Array.isArray(args[0]))], MathHelpers, "extractMinAndMax", null);
/**
...
function FixFlippedFaces(positions, indices) {
	...
	const inside = boundingInfo.maximum.subtract(boundingInfo.minimum).scale(.5).add(boundingInfo.minimum);
...
//#endregion
export { extractMinAndMax as n, extractMinAndMaxIndexed as r, FixFlippedFaces as t };

//# sourceMappingURL=math.functions-BEm1ja6K.js.map