...
var CreateWorkerAsync = async () => {
	if (!WorkerPromise) WorkerPromise = new Promise((res, reject) => {
		if (LocalWorker) res(LocalWorker);
...
var basisTextureLoader_exports = /* @__PURE__ */ __exportAll({ _BasisTextureLoader: () => _BasisTextureLoader });
/**
...
//#endregion
export { BasisToolsOptions as a, LoadTextureFromTranscodeResult as c, BasisTools as i, SetBasisTranscoderWorker as l, basisTextureLoader_exports as n, BasisTranscodeConfiguration as o, BasisFileInfo as r, GetInternalFormatFromBasisFormat as s, _BasisTextureLoader as t, TranscodeAsync as u };

//# sourceMappingURL=basisTextureLoader-CJkOn94g.js.map