...
var name$23 = "samplerFragmentAlternateDeclaration";
var shader$23 = `#ifdef _DEFINENAME_
...
var name$22 = "pbrFragmentSamplersDeclaration";
var shader$22 = `#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
var name$21 = "pbrBlockAlbedoOpacity";
var shader$21 = `struct albedoOpacityOutParams
...
var name$20 = "pbrBlockReflectivity";
var shader$20 = `struct reflectivityOutParams
...
var name$19 = "pbrBlockAmbientOcclusion";
var shader$19 = `struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
var name$18 = "pbrBlockAlphaFresnel";
var shader$18 = `#ifdef ALPHAFRESNEL
...
var name$17 = "pbrBlockAnisotropic";
var shader$17 = `#ifdef ANISOTROPIC
...
var name$16 = "pbrBlockReflection";
var shader$16 = `#ifdef REFLECTION
...
var name$15 = "pbrBlockSheen";
var shader$15 = `#ifdef SHEEN
...
var name$14 = "pbrBlockClearcoat";
var shader$14 = `struct clearcoatOutParams
...
var name$13 = "pbrBlockIridescence";
var shader$13 = `struct iridescenceOutParams
...
var name$12 = "pbrBlockSubSurface";
var shader$12 = `struct subSurfaceOutParams
...
var name$11 = "pbrBlockReflectance0";
var shader$11 = `float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
...
//#endregion
//#region node_modules/@babylonjs/core/Shaders/ShadersInclude/pbrClusteredLightingFunctions.js
var name$10 = "pbrClusteredLightingFunctions";
var shader$10 = `#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
var name$9 = "pbrBlockNormalFinal";
var shader$9 = `#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
var name$8 = "pbrBlockLightmapInit";
var shader$8 = `#ifdef LIGHTMAP
...
var name$7 = "pbrBlockGeometryInfo";
var shader$7 = `float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
var name$6 = "pbrBlockReflectance";
var shader$6 = `#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
var name$5 = "pbrBlockDirectLighting";
var shader$5 = `vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
var name$4 = "pbrBlockFinalLitComponents";
var shader$4 = `aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
var name$3 = "pbrBlockFinalUnlitComponents";
var shader$3 = `vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
var name$2 = "pbrBlockFinalColorComposition";
var shader$2 = `vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
var shader = `#define PBR_FRAGMENT_SHADER
...
//# sourceMappingURL=pbr.fragment-DXCHd8NR.js.map