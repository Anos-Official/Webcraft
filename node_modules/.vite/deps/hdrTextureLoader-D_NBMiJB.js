...
var PanoramaToCubeMapTools = class {
	...
	*/
	static ConvertPanoramaToCubemap(float32Array, inputWidth, inputHeight, size, supersample = false, invertY = true) {
		...
		let stride;
		if (float32Array.length != inputWidth * inputHeight * 3) if (float32Array.length != inputWidth * inputHeight * 4) throw "ConvertPanoramaToCubemap: input size is wrong";
		else stride = 4;
		else stride = 3;
		return {
			front: this.CreateCubemapTexture(size, this.FACE_FRONT, float32Array, inputWidth, inputHeight, supersample, invertY, stride),
			back: this.CreateCubemapTexture(size, this.FACE_BACK, float32Array, inputWidth, inputHeight, supersample, invertY, stride),
			left: this.CreateCubemapTexture(size, this.FACE_LEFT, float32Array, inputWidth, inputHeight, supersample, invertY, stride),
			right: this.CreateCubemapTexture(size, this.FACE_RIGHT, float32Array, inputWidth, inputHeight, supersample, invertY, stride),
			up: this.CreateCubemapTexture(size, this.FACE_UP, float32Array, inputWidth, inputHeight, supersample, invertY, stride),
			down: this.CreateCubemapTexture(size, this.FACE_DOWN, float32Array, inputWidth, inputHeight, supersample, invertY, stride),
			size,
			type: 1,
			format: 4,
			gammaSpace: false
	...
	static CalcProjectionSpherical(vDir, float32Array, inputWidth, inputHeight, stride, invertY) {
		...
		return {
			r: float32Array[inputY * inputWidth * stride + px * stride + 0],
			g: float32Array[inputY * inputWidth * stride + px * stride + 1],
			b: float32Array[inputY * inputWidth * stride + px * stride + 2]
		};
	}
};
...
var hdrTextureLoader_exports = /* @__PURE__ */ __exportAll({ _HDRTextureLoader: () => _HDRTextureLoader });
/**
...
//#endregion
export { PanoramaToCubeMapTools as a, HDRTools as i, hdrTextureLoader_exports as n, GetCubeMapTextureData as r, _HDRTextureLoader as t };

//# sourceMappingURL=hdrTextureLoader-D_NBMiJB.js.map