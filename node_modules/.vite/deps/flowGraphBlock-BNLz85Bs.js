...
function defaultValueParseFunction(key, serializationObject, assetsContainer, scene) {
	...
	else if (Array.isArray(intermediateValue)) if (intermediateValue.length > 0 && typeof intermediateValue[0] === "object" && intermediateValue[0] !== null && "eventData" in intermediateValue[0]) finalValue = intermediateValue.reduce((acc, val) => {
...
//# sourceMappingURL=flowGraphBlock-BNLz85Bs.js.map