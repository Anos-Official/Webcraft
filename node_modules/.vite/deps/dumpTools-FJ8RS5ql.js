...
import { F as EncodeArrayBufferToBase64, n as Tools } from "./tools-CjHzo3M6.js";
import { r as nativeOverride, v as __decorate } from "./decorators-C0OZDeZS.js";
import { n as EffectWrapper, t as EffectRenderer } from "./effectRenderer-DyZWNPGG.js";
...
async function _CreateDumpResourcesAsync() {
	...
	const { ThinEngine: thinEngineClass } = await import("./thinEngine-Dim78jpq.js").then((n) => n.n);
	...
	const { passPixelShader } = await import("./pass.fragment-BbGz-xqg.js").then((n) => n.n);
	return {
		canvas,
		dumpEngine: {
			engine,
...
//# sourceMappingURL=dumpTools-FJ8RS5ql.js.map