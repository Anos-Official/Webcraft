import { E as __exportAll, c as ILog2 } from "./math.scalar.functions-DMYdgtAr.js";
import { n as Observable } from "./observable-Dg5nDoxE.js";
import { a as Vector3, b as Epsilon, n as Quaternion, o as Vector4, r as TmpVectors, t as Matrix, v as BuildArray } from "./math.vector-ivCpDlc6.js";
import { r as RegisterClass, t as GetClass } from "./typeStore-Dy-yCYbL.js";
import { t as EngineStore } from "./engineStore-Cs1hlddx.js";
import { n as Color4, t as Color3 } from "./math.color-BkO_SHWK.js";
import { t as Logger } from "./logger-CE6knO9r.js";
import { H as ErrorCodes, U as RuntimeError, k as GetTypeByteLength, n as Tools } from "./tools-CjHzo3M6.js";
import { g as serializeAsVector3, i as serialize, p as serializeAsQuaternion, r as nativeOverride, v as __decorate } from "./decorators-C0OZDeZS.js";
import { t as _WarnImport } from "./devTools-CGiGDI7K.js";
import { n as SerializationHelper } from "./math.size-DQcnuHgY.js";
import { t as Node } from "./node-CfdDXNL4.js";
import { i as IsDocumentAvailable, o as IsWindowObjectExist, t as PrecisionDate } from "./precisionDate-Cd3oUFQl.js";
import { B as allocateAndCopyTypedBuffer, M as Initialize, P as Process, c as InternalTexture, d as AlphaState, g as resetCachedPipeline, h as Effect, j as Finalize, m as DepthCullingState, o as AbstractEngine, p as StencilStateComposer } from "./tools.functions-B2mppQhq.js";
import { t as ShaderStore } from "./shaderStore-CoW3hXTv.js";
import { t as UniformBuffer } from "./uniformBuffer-DLLFhL0q.js";
import { t as DataBuffer } from "./dataBuffer-BC17yCmb.js";
import { n as VertexBuffer, t as Buffer } from "./buffer-C-R11gtg.js";
import { t as PickingInfo } from "./pickingInfo-C3hJX0-p.js";
import { t as PerfCounter } from "./perfCounter-DnwVSKwz.js";
import { n as extractMinAndMax, r as extractMinAndMaxIndexed } from "./math.functions-BEm1ja6K.js";
import { i as DrawWrapper } from "./effectRenderer-DyZWNPGG.js";
import { n as SphericalPolynomial, s as FromHalfFloat, y as Axis } from "./sphericalPolynomial-39r6-uP_.js";
import { i as IsWrapper, n as HasStencilAspect, t as GetTypeForDepthTexture } from "./textureHelper.functions-BgvmX_ZU.js";
import { n as _SpatialAudioAttacherComponent, t as _SpatialWebAudioUpdaterComponent } from "./spatialWebAudioUpdaterComponent-BPH9Akd-.js";
import { i as _WebAudioParameterComponent, t as AbstractAudioNode } from "./abstractAudioNode-iPMGG31J.js";
import { t as _GetCompatibleTextureLoader } from "./textureLoaderManager-CznqcFfr.js";
import "./sceneUboDeclaration-CiSiC8tn.js";
import "./meshUboDeclaration-CNxmvjAL.js";
import "./helperFunctions-CrWn5igy.js";
import "./bakedVertexAnimationDeclaration-CZo3B38p.js";
import "./instancesDeclaration-nBVnHQYq.js";
import "./instancesVertex-HL66YAjZ.js";
import "./bakedVertexAnimation-Gnkvy4Hr.js";
import { t as WebGPUPerfCounter } from "./webgpuPerfCounter-CbfNyufK.js";
import "./fresnelFunction-C3QivgMe.js";
import "./decalFragment-o8K-4Fjc.js";
...
var TransformNode = class TransformNode extends Node {
	...
	*/
	computeWorldMatrix(force = false, camera = null) {
		...
		if (camera && this.billboardMode) if (!cache.useBillboardPosition) {
			...
			if (isRH) TmpVectors.Matrix[1].multiplyToRef(TransformNode._TmpRHRestore, TmpVectors.Matrix[1]);
	...
	*/
	serialize(currentSerializationObject) {
		...
		if (this._isWorldMatrixFrozen) serializationObject.freezeWorldMatrix = true;
	...
	*/
	static Parse(parsedTransformNode, scene, rootUrl) {
		...
		if (parsedTransformNode.freezeWorldMatrix) transformNode._waitingFreezeWorldMatrix = parsedTransformNode.freezeWorldMatrix;
	...
	static ComputeNormals(positions, indices, normals, options) {
		...
		for (index = 0; index < nbFaces; index++) {
			...
			if (computeFacetPartitioning && options) {
				...
				if (blockIdxV2 != blockIdxV1) options.facetPartitioning[blockIdxV2].push(index);
				if (!(blockIdxV3 == blockIdxV2 || blockIdxV3 == blockIdxV1)) options.facetPartitioning[blockIdxV3].push(index);
				if (!(blockIdxV4 == blockIdxV1 || blockIdxV4 == blockIdxV2 || blockIdxV4 == blockIdxV3)) options.facetPartitioning[blockIdxV4].push(index);
			}
...
__decorate([nativeOverride.filter((...args) => !Array.isArray(args[0]))], VertexData, "_TransformVector3Coordinates", null);
__decorate([nativeOverride.filter((...args) => !Array.isArray(args[0]))], VertexData, "_TransformVector3Normals", null);
__decorate([nativeOverride.filter((...args) => !Array.isArray(args[0]))], VertexData, "_TransformVector4Normals", null);
__decorate([nativeOverride.filter((...args) => !Array.isArray(args[0]))], VertexData, "_FlipFaces", null);
//#endregion
...
var AbstractMesh = class AbstractMesh extends TransformNode {
	...
	*/
	async optimizeIndicesAsync() {
		...
		const { OptimizeIndices } = await import("./mesh.vertexData.functions-B88t7ye8.js").then((n) => n.n);
...
__decorate([nativeOverride.filter((...args) => !Array.isArray(args[0]) && !Array.isArray(args[3]) && !Array.isArray(args[4]) && !Array.isArray(args[5]) && !Array.isArray(args[6]))], AbstractMesh, "_ApplySkeleton", null);
RegisterClass("BABYLON.AbstractMesh", AbstractMesh);
//#endregion
//#region node_modules/@babylonjs/core/AudioV2/abstractAudio/audioEngineV2.js
var Instances = [];
/**
...
var AudioEngineV2 = class {
	constructor(options) {
		...
		this._parameterRampDuration = .01;
		Instances.push(this);
		if (typeof options.parameterRampDuration === "number") this.parameterRampDuration = options.parameterRampDuration;
	}
	/**
	...
	*/
	get defaultMainBus() {
		if (this._mainBuses.size === 0) return null;
		if (!this._defaultMainBus) this._defaultMainBus = Array.from(this._mainBuses)[0];
	...
	*/
	get sounds() {
		if (!this._soundsArray) this._soundsArray = Array.from(this._sounds);
	...
	*/
	dispose() {
		...
		for (let next = nodeIt.next(); !next.done; next = nodeIt.next()) next.value.dispose();
...
function _GetAudioEngine(engine) {
	if (!engine) engine = LastCreatedAudioEngine();
...
//#endregion
//#region node_modules/@babylonjs/core/AudioV2/abstractAudio/subProperties/abstractSpatialAudioListener.js
...
//#endregion
//#region node_modules/@babylonjs/core/AudioV2/abstractAudio/subProperties/spatialAudioListener.js
/** @internal */
var _SpatialAudioListener = class extends AbstractSpatialAudioListener {
	...
	*/
	...
	/** @internal */
	setOptions(options) {
		if (options.listenerMinUpdateTime !== void 0) this.minUpdateTime = options.listenerMinUpdateTime;
		if (options.listenerPosition) this.position = options.listenerPosition.clone();
		if (options.listenerRotationQuaternion) this.rotationQuaternion = options.listenerRotationQuaternion.clone();
		else if (options.listenerRotation) this.rotation = options.listenerRotation.clone();
		else this.rotationQuaternion = _SpatialAudioListenerDefaults.rotationQuaternion.clone();
		this.update();
	}
};
//#endregion
//#region node_modules/@babylonjs/core/AudioV2/webAudio/subProperties/spatialWebAudioListener.js
...
function _CreateSpatialAudioListener(engine, autoUpdate, minUpdateTime) {
	...
	if (listener.forwardX && listener.forwardY && listener.forwardZ && listener.positionX && listener.positionY && listener.positionZ && listener.upX && listener.upY && listener.upZ) return new _SpatialWebAudioListener(engine, autoUpdate, minUpdateTime);
	else return new _SpatialWebAudioListenerFallback(engine, autoUpdate, minUpdateTime);
}
...
var _SpatialWebAudioListener = class extends _AbstractSpatialWebAudioListener {
	...
	_setWebAudioPosition(position) {
		if (this.isAttached && (this._positionX.isRamping || this._positionY.isRamping || this._positionZ.isRamping)) return;
	...
	_setWebAudioOrientation(forward, up) {
		if (this.isAttached && (this._forwardX.isRamping || this._forwardY.isRamping || this._forwardZ.isRamping || this._upX.isRamping || this._upY.isRamping || this._upZ.isRamping)) return;
...
//#endregion
//#region node_modules/@babylonjs/core/AudioV2/abstractAudio/mainAudioOut.js
/**
...
//#endregion
//#region node_modules/@babylonjs/core/AudioV2/webAudio/webAudioMainOut.js
/** @internal */
var _WebAudioMainOut = class extends _MainAudioOut {
	...
	set _inNode(value) {
		if (this._gainNode === value) return;
	...
	_setGainNode(gainNode) {
		if (this._gainNode === gainNode) return;
		this._gainNode?.disconnect();
...
//#endregion
//#region node_modules/@babylonjs/core/AudioV2/webAudio/webAudioUnmuteUI.js
/**
...
var _WebAudioUnmuteUI = class {
	...
	constructor(engine, parentElement) {
		...
		this._onStateChanged = () => {
			...
			if (this._engine.state === "running") this._hide();
			else this._show();
		};
		this._engine = engine;
	...
	set enabled(value) {
		this._enabled = value;
		if (value) {
			if (this._engine.state !== "running") this._show();
		} else this._hide();
	}
	_show() {
		if (!this._button || !this._enabled) return;
...
//#endregion
//#region node_modules/@babylonjs/core/AudioV2/webAudio/webAudioEngine.js
/**
...
var _WebAudioEngine = class extends AudioEngineV2 {
	...
	constructor(options = {}) {
		...
		this._onUserGestureAsync = async () => {
			if (this._resumeOnInteraction) await this._audioContext.resume();
		...
		this._startUpdating = () => {
			...
			if (this.state === "running") this._update();
			else {
				const callback = () => {
					if (this.state === "running") {
						this._update();
		...
		this._update = () => {
			...
			} else this._isUpdating = false;
		};
		if (typeof options.listenerAutoUpdate === "boolean") this._listenerAutoUpdate = options.listenerAutoUpdate;
		if (typeof options.listenerMinUpdateTime === "number") this._listenerMinUpdateTime = options.listenerMinUpdateTime;
		...
		if (!options.disableDefaultUI) this._unmuteUI = new _WebAudioUnmuteUI(this, options.defaultUIParentElement);
	}
	/** @internal */
	...
	set volume(value) {
		...
		this._volume = value;
		if (this._mainOut) this._mainOut.volume = value;
	}
	/**
	...
	*/
	...
	set _unmuteUIEnabled(value) {
		if (this._unmuteUI) this._unmuteUI.enabled = value;
	}
	/** @internal */
	async createBusAsync(name, options = {}) {
		const bus = new (await (import("./webAudioBus-D7rABMuj.js").then((n) => n.n)))._WebAudioBus(name, this, options);
		await bus._initAsync(options);
		return bus;
	}
	/** @internal */
	async createMainBusAsync(name, options = {}) {
		const bus = new (await (import("./webAudioMainBus-CjW9Vw06.js").then((n) => n.n)))._WebAudioMainBus(name, this);
		await bus._initAsync(options);
		return bus;
	}
	/** @internal */
	...
	async createSoundAsync(name, source, options = {}) {
		const sound = new (await (import("./webAudioStaticSound-Err4ZGlw.js").then((n) => n.r)))._WebAudioStaticSound(name, this, options);
		await sound._initAsync(source, options);
		return sound;
	}
	/** @internal */
	async createSoundBufferAsync(source, options = {}) {
		const soundBuffer = new (await (import("./webAudioStaticSound-Err4ZGlw.js").then((n) => n.r)))._WebAudioStaticSoundBuffer(this);
		await soundBuffer._initAsync(source, options);
		return soundBuffer;
	}
	/** @internal */
	async createSoundSourceAsync(name, source, options = {}) {
		const soundSource = new (await (import("./webAudioSoundSource-CIK_K0_7.js").then((n) => n.n)))._WebAudioSoundSource(name, source, this, options);
		await soundSource._initAsync(options);
		return soundSource;
	}
	/** @internal */
	async createStreamingSoundAsync(name, source, options = {}) {
		const sound = new (await (import("./webAudioStreamingSound-BKCLuwrZ.js").then((n) => n.n)))._WebAudioStreamingSound(name, this, options);
		await sound._initAsync(source, options);
		return sound;
	}
	/** @internal */
	dispose() {
		...
		this._listener = null;
		if (this._audioContext.state !== "closed" && !this._isUsingOfflineAudioContext) this._audioContext.close();
	...
	isFormatValid(format) {
		if (this._validFormats.has(format)) return true;
		if (this._invalidFormats.has(format)) return false;
	...
	/** @internal */
	setVolume(value, options = null) {
		if (this._mainOut) this._mainOut.setVolume(value, options);
		else throw new Error("Main output not initialized yet.");
	}
	/** @internal */
	_addMainBus(mainBus) {
	...
	_onSoundPlaybackStateChanged() {
		...
		const hasActiveSounds = this.sounds.some((s) => s.state === 3 || s.state === 2 || s.state === 0);
		if (hasActiveSounds && this._silentHtmlAudio.paused) this._silentHtmlAudio.play().catch(() => {});
		else if (!hasActiveSounds && !this._silentHtmlAudio.paused) this._silentHtmlAudio.pause();
	}
	/** @internal */
	_addUpdateObserver(callback) {
		if (!this._updateObservable) this._updateObservable = new Observable();
		this._updateObservable.add(callback);
		this._startUpdating();
	}
	_removeUpdateObserver(callback) {
		if (this._updateObservable) this._updateObservable.removeCallback(callback);
	}
};
//#endregion
//#region node_modules/@babylonjs/core/Audio/audioEngine.js
...
var AudioEngine = class {
	...
	*/
	get audioContext() {
		if (this._v2.state === "running") this._triggerRunningStateAsync();
	...
	*/
	lock() {
		...
		if (!this._useCustomUnlockedButton) this._v2._unmuteUIEnabled = true;
	}
	/**
	...
	*/
	...
	_resumeAudioContextOnStateChange() {
		this._v2._audioContext?.addEventListener("statechange", () => {
			if (this.unlocked && this._v2._audioContext?.state !== "running") this._resumeAudioContextAsync();
		}, {
			once: true,
			passive: true,
	...
	_resumeAudioContextAsync() {
		if (this._v2._isUsingOfflineAudioContext) return Promise.resolve();
		if (this._v2._audioContext.state === "suspended" && !this._useCustomUnlockedButton) this._v2._unmuteUIEnabled = true;
	...
	*/
	connectToAnalyser(analyser) {
		if (this._connectedAnalyser) this._connectedAnalyser.stopDebugCanvas();
...
//#endregion
//#region node_modules/@babylonjs/core/Buffers/buffer.align.js
var IsLittleEndian = (() => {
...
VertexBuffer.prototype._alignBuffer = function() {
	...
	if (!this.engine._features.forceVertexBufferStrideAndOffsetMultiple4Bytes || this.byteStride % 4 === 0 && this.byteOffset % 4 === 0 || !data) return;
	...
	const totalLength = totalVertices * alignedByteStride / typeByteLength;
	let sourceData;
	...
	} else if (ArrayBuffer.isView(data)) sourceData = new DataView(data.buffer, data.byteOffset, data.byteLength);
	else sourceData = new DataView(data, 0, data.byteLength);
	let alignedData;
	if (this.type === VertexBuffer.BYTE) alignedData = new Int8Array(totalLength);
	else if (this.type === VertexBuffer.UNSIGNED_BYTE) alignedData = new Uint8Array(totalLength);
	else if (this.type === VertexBuffer.SHORT) alignedData = new Int16Array(totalLength);
	else if (this.type === VertexBuffer.UNSIGNED_SHORT) alignedData = new Uint16Array(totalLength);
	else if (this.type === VertexBuffer.INT) alignedData = new Int32Array(totalLength);
	else if (this.type === VertexBuffer.UNSIGNED_INT) alignedData = new Uint32Array(totalLength);
	else alignedData = new Float32Array(totalLength);
	const numComponents = this.getSize();
	let sourceOffset = this.byteOffset;
	for (let i = 0; i < totalVertices; ++i) {
		for (let j = 0; j < numComponents; ++j) switch (this.type) {
...
var RenderTargetWrapper = class {
	...
	*/
	generateMipMaps() {
		if (this._engine._currentRenderTarget === this) if (this.isMulti) this._engine.unBindMultiColorAttachmentFramebuffer(this, true);
		else this._engine.unBindFramebuffer(this, true);
...
AbstractEngine.prototype.setAlphaEquation = function(equation, targetIndex = 0) {
	if (this._alphaEquation[targetIndex] === equation) return;
	switch (equation) {
		case 0:
...
//#endregion
//#region node_modules/@babylonjs/core/Engines/AbstractEngine/abstractEngine.stencil.js
...
function _CommonInit(commonEngine, canvas, creationOptions) {
	...
	if (!creationOptions.doNotHandleTouchAction) DisableTouchAction(canvas);
...
//#endregion
//#region node_modules/@babylonjs/core/Misc/codeStringParsingTools.js
/**
...
function ExtractBetweenMarkers(markerOpen, markerClose, block, startIndex) {
	...
	while (currPos < block.length) {
		...
		if (!waitForChar) switch (currChar) {
			case markerOpen:
				openMarkers++;
				break;
			case markerClose:
			...
			case "/":
				if (currPos + 1 < block.length) {
					...
					if (nextChar === "/") waitForChar = "\n";
					else if (nextChar === "*") waitForChar = "*/";
				}
				break;
		}
		else if (currChar === waitForChar) if (waitForChar === "\"" || waitForChar === "'") block.charAt(currPos - 1) !== "\\" && (waitForChar = "");
		else waitForChar = "";
		else if (waitForChar === "*/" && currChar === "*" && currPos + 1 < block.length) {
			block.charAt(currPos + 1) === "/" && (waitForChar = "");
			if (waitForChar === "") currPos++;
		}
		currPos++;
		if (openMarkers === 0) break;
	}
...
function RemoveComments(block) {
	...
	while (currPos < block.length) {
		...
		if (!waitForChar) {
			...
			if (!inComments) s.push(currChar);
		} else if (currChar === waitForChar) if (waitForChar === "\"" || waitForChar === "'") {
			block.charAt(currPos - 1) !== "\\" && (waitForChar = "");
			s.push(currChar);
		} else {
			waitForChar = "";
		...
		} else if (!inComments) s.push(currChar);
		currPos++;
	}
	return s.join("");
}
...
function FindBackward(s, index, c, c2) {
	while (index >= 0 && s.charAt(index) !== c && (!c2 || s.charAt(index) !== c2)) index--;
	return index;
}
/**
...
//#endregion
//#region node_modules/@babylonjs/core/Engines/Processors/shaderCodeInliner.js
/**
* Class used to inline functions in shader code
*/
var ShaderCodeInliner = class ShaderCodeInliner {
	...
	*/
	processCode() {
		if (this.debug) Logger.Log(`Start inlining process (code size=${this._sourceCode.length})...`);
		this._collectFunctions();
		this._processInlining(this._numMaxIterations);
		if (this.debug) Logger.Log("End of inlining process.");
	}
	_collectFunctions() {
		let startIndex = 0;
		while (startIndex < this._sourceCode.length) {
			const inlineTokenIndex = this._sourceCode.indexOf(this.inlineToken, startIndex);
			if (inlineTokenIndex < 0) break;
			const funcParamsStartIndex = this._sourceCode.indexOf("(", inlineTokenIndex + this.inlineToken.length);
			if (funcParamsStartIndex < 0) {
				if (this.debug) Logger.Warn(`Could not find the opening parenthesis after the token. startIndex=${startIndex}`);
			...
			if (!funcNameMatch) {
				if (this.debug) Logger.Warn(`Could not extract the name/type of the function from: ${this._sourceCode.substring(inlineTokenIndex + this.inlineToken.length, funcParamsStartIndex)}`);
				startIndex = inlineTokenIndex + this.inlineToken.length;
				continue;
			}
			...
			if (funcParamsEndIndex < 0) {
				if (this.debug) Logger.Warn(`Could not extract the parameters the function '${funcName}' (type=${funcType}). funcParamsStartIndex=${funcParamsStartIndex}`);
				startIndex = inlineTokenIndex + this.inlineToken.length;
				continue;
			}
			...
			if (funcBodyStartIndex === this._sourceCode.length) {
				if (this.debug) Logger.Warn(`Could not extract the body of the function '${funcName}' (type=${funcType}). funcParamsEndIndex=${funcParamsEndIndex}`);
				startIndex = inlineTokenIndex + this.inlineToken.length;
				continue;
			}
			const funcBodyEndIndex = ExtractBetweenMarkers("{", "}", this._sourceCode, funcBodyStartIndex);
			if (funcBodyEndIndex < 0) {
				if (this.debug) Logger.Warn(`Could not extract the body of the function '${funcName}' (type=${funcType}). funcBodyStartIndex=${funcBodyStartIndex}`);
				startIndex = inlineTokenIndex + this.inlineToken.length;
				continue;
			}
			...
			for (let p = 0; p < params.length; ++p) {
				...
				if (idx >= 0) paramNames.push(param.substring(idx + 1));
			}
			if (funcType !== "void") paramNames.push("return");
		...
		if (this.debug) Logger.Log(`Collect functions: ${this._functionDescr.length} functions found. functionDescr=${this._functionDescr}`);
	}
	_processInlining(numMaxIterations = 20) {
		while (numMaxIterations-- >= 0) if (!this._replaceFunctionCallsByCode()) break;
		if (this.debug) Logger.Log(`numMaxIterations is ${numMaxIterations} after inlining process`);
		...
		for (const func of this._functionDescr) {
			...
			while (startIndex < this._sourceCode.length) {
				...
				if (callParamsEndIndex < 0) {
					if (this.debug) Logger.Warn(`Could not extract the parameters of the function call. Function '${name}' (type=${type}). callParamsStartIndex=${callParamsStartIndex}`);
					startIndex = functionCallIndex + name.length;
					continue;
				}
				...
				const splitParameterCall = (s) => {
					...
					if (startParamIdx < curIdx) parameters.push(s.substring(startParamIdx, curIdx));
					return parameters;
				};
				const params = splitParameterCall(RemoveComments(callParams));
				if (params === null) {
					if (this.debug) Logger.Warn(`Invalid function call: can't extract the parameters of the function call. Function '${name}' (type=${type}). callParamsStartIndex=${callParamsStartIndex}, callParams=` + callParams);
					startIndex = functionCallIndex + name.length;
					continue;
				}
				const paramNames = [];
				...
				if (retParamName) paramNames.push(retParamName + " =");
				if (paramNames.length !== parameters.length) {
					if (this.debug) Logger.Warn(`Invalid function call: not the same number of parameters for the call than the number expected by the function. Function '${name}' (type=${type}). function parameters=${parameters}, call parameters=${paramNames}`);
					startIndex = functionCallIndex + name.length;
					continue;
				}
				...
				if (retParamName) {
					...
					if (this.debug) Logger.Log(`Replace function call by code. Function '${name}' (type=${type}). injectDeclarationIndex=${injectDeclarationIndex}, call parameters=${paramNames}`);
				} else {
					this._sourceCode = partBefore + funcBody + partAfter;
					startIndex += funcBody.length - (callParamsEndIndex + 1 - functionCallIndex);
					if (this.debug) Logger.Log(`Replace function call by code. Function '${name}' (type=${type}). functionCallIndex=${functionCallIndex}, call parameters=${paramNames}`);
				}
				doAgain = true;
			}
		}
	...
	_replaceNames(code, sources, destinations) {
		for (let i = 0; i < sources.length; ++i) {
			...
			code = code.replace(source, (match, ...args) => {
				const offset = args[0];
				if (IsIdentifierChar(code.charAt(offset - 1)) || IsIdentifierChar(code.charAt(offset + sourceLen))) return sources[i];
				return destination;
			});
		}
		return code;
...
//#endregion
//#region node_modules/@babylonjs/core/Buffers/buffer.nonFloatVertexBuffers.js
...
function IsSignedType(type) {
	switch (type) {
		...
		case VertexBuffer.SHORT:
		case VertexBuffer.INT:
		case VertexBuffer.FLOAT: return true;
		case VertexBuffer.UNSIGNED_BYTE:
		case VertexBuffer.UNSIGNED_SHORT:
		case VertexBuffer.UNSIGNED_INT: return false;
...
function checkNonFloatVertexBuffers(vertexBuffers, effect) {
	...
	if (!pipelineContext?.vertexBufferKindToType) return;
	let shaderProcessingContext = null;
	for (const kind in vertexBuffers) {
		const currentVertexBuffer = vertexBuffers[kind];
		if (!currentVertexBuffer || !VertexBufferKindForNonFloatProcessing[kind]) continue;
		...
		if (currentVertexBufferType !== VertexBuffer.FLOAT && vertexBufferType === void 0 || vertexBufferType !== void 0 && vertexBufferType !== currentVertexBufferType) {
			if (!shaderProcessingContext) shaderProcessingContext = engine._getShaderProcessingContext(effect.shaderLanguage, false);
			...
			if (currentVertexBufferType !== VertexBuffer.FLOAT) {
				...
				if (IsSignedType(currentVertexBufferType)) shaderProcessingContext.vertexBufferKindToNumberOfComponents[kind] *= -1;
			}
		}
	}
...
//#endregion
//#region node_modules/@babylonjs/core/Engines/AbstractEngine/abstractEngine.query.js
/** @internal */
...
Object.defineProperty(AbstractMesh.prototype, "_occlusionDataStorage", {
	get: function() {
		if (!this.__occlusionDataStorage) this.__occlusionDataStorage = new _OcclusionDataStorage();
...
AbstractMesh.prototype._checkOcclusionQuery = function(checkOnly) {
	...
	if (this.isOcclusionQueryInProgress && this._occlusionQuery !== null && this._occlusionQuery !== void 0) if (engine.isQueryResultAvailable(this._occlusionQuery)) {
		...
		} else return dataStorage.occlusionType === AbstractMesh.OCCLUSION_TYPE_OPTIMISTIC ? false : dataStorage.isOccluded;
	}
	if (checkOnly) return dataStorage.isOccluded;
	const scene = this.getScene();
	if (scene.getBoundingBoxRenderer) {
		const occlusionBoundingBoxRenderer = scene.getBoundingBoxRenderer();
		if (this._occlusionQuery === null) this._occlusionQuery = engine.createQuery();
...
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGPU/webgpuTextureHelper.js
/** @internal */
var WebGPUTextureHelper = class {
	...
	static GetTextureTypeFromFormat(format) {
		switch (format) {
			...
			case "rg16uint":
			case "rgba16uint":
			case "depth16unorm": return 5;
			case "r16sint":
			case "r16snorm":
			case "rg16snorm":
			case "rgba16snorm":
			case "rg16sint":
			case "rgba16sint": return 4;
			case "r16float":
			case "rg16float":
			case "rgba16float": return 2;
			case "r32uint":
			case "rg32uint":
			case "rgba32uint": return 7;
			case "r32sint":
			case "rg32sint":
			case "rgba32sint": return 7;
			case "r32float":
			case "rg32float":
			case "rgba32float":
			case "depth32float":
			...
			case "depth24plus":
			case "depth24plus-stencil8": return 1;
		}
		return 0;
	}
	static GetBlockInformationFromFormat(format) {
		switch (format) {
			...
			case "rgba32uint":
			case "rgba32sint":
			case "rgba32float": return {
				width: 1,
				height: 1,
				length: 16
			};
			case "stencil8": throw "No fixed size for Stencil8 format!";
			case "depth16unorm": return {
				width: 1,
				height: 1,
				length: 2
			};
			case "depth24plus": throw "No fixed size for Depth24Plus format!";
			case "depth24plus-stencil8": throw "No fixed size for Depth24PlusStencil8 format!";
			case "depth32float": return {
				width: 1,
				height: 1,
				length: 4
			};
			case "depth32float-stencil8": return {
				width: 1,
				height: 1,
				length: 5
			};
			...
			case "bc3-rgba-unorm-srgb":
			case "bc2-rgba-unorm":
			case "bc2-rgba-unorm-srgb": return {
				width: 4,
				height: 4,
				length: 16
			};
			...
			case "bc4-r-snorm":
			case "bc1-rgba-unorm":
			case "bc1-rgba-unorm-srgb": return {
				width: 4,
				height: 4,
				length: 8
			};
			...
			case "etc2-rgba8unorm-srgb":
			case "eac-rg11unorm":
			case "eac-rg11snorm": return {
				width: 4,
				height: 4,
				length: 16
			};
			case "astc-4x4-unorm":
			case "astc-4x4-unorm-srgb": return {
				width: 4,
				height: 4,
				length: 16
			};
			case "astc-5x4-unorm":
			case "astc-5x4-unorm-srgb": return {
				width: 5,
				height: 4,
				length: 16
			};
			case "astc-5x5-unorm":
			case "astc-5x5-unorm-srgb": return {
				width: 5,
				height: 5,
				length: 16
			};
			case "astc-6x5-unorm":
			case "astc-6x5-unorm-srgb": return {
				width: 6,
				height: 5,
				length: 16
			};
			case "astc-6x6-unorm":
			case "astc-6x6-unorm-srgb": return {
				width: 6,
				height: 6,
				length: 16
			};
			case "astc-8x5-unorm":
			case "astc-8x5-unorm-srgb": return {
				width: 8,
				height: 5,
				length: 16
			};
			case "astc-8x6-unorm":
			case "astc-8x6-unorm-srgb": return {
				width: 8,
				height: 6,
				length: 16
			};
			case "astc-8x8-unorm":
			case "astc-8x8-unorm-srgb": return {
				width: 8,
				height: 8,
				length: 16
			};
			case "astc-10x5-unorm":
			case "astc-10x5-unorm-srgb": return {
				width: 10,
				height: 5,
				length: 16
			};
			case "astc-10x6-unorm":
			case "astc-10x6-unorm-srgb": return {
				width: 10,
				height: 6,
				length: 16
			};
			case "astc-10x8-unorm":
			case "astc-10x8-unorm-srgb": return {
				width: 10,
				height: 8,
				length: 16
			};
			case "astc-10x10-unorm":
			case "astc-10x10-unorm-srgb": return {
				width: 10,
				height: 10,
				length: 16
			};
			case "astc-12x10-unorm":
			case "astc-12x10-unorm-srgb": return {
				width: 12,
				height: 10,
				length: 16
			};
			case "astc-12x12-unorm":
			case "astc-12x12-unorm-srgb": return {
				width: 12,
				height: 12,
				length: 16
			};
	...
	static IsCompressedFormat(format) {
		switch (format) {
			...
			case "astc-12x10-unorm-srgb":
			case "astc-12x12-unorm":
			case "astc-12x12-unorm-srgb": return true;
		}
		return false;
	}
	static GetWebGPUTextureFormat(type, format, useSRGBBuffer = false) {
		switch (format) {
			case 15: return "depth16unorm";
			case 16: return "depth24plus";
			case 13: return "depth24plus-stencil8";
			case 14: return "depth32float";
			case 18: return "depth32float-stencil8";
			case 19: return "stencil8";
			case 36492: return useSRGBBuffer ? "bc7-rgba-unorm-srgb" : "bc7-rgba-unorm";
			case 36495: return "bc6h-rgb-ufloat";
			case 36494: return "bc6h-rgb-float";
			case 33779: return useSRGBBuffer ? "bc3-rgba-unorm-srgb" : "bc3-rgba-unorm";
			case 33778: return useSRGBBuffer ? "bc2-rgba-unorm-srgb" : "bc2-rgba-unorm";
			case 33777:
			case 33776: return useSRGBBuffer ? "bc1-rgba-unorm-srgb" : "bc1-rgba-unorm";
			case 37808: return useSRGBBuffer ? "astc-4x4-unorm-srgb" : "astc-4x4-unorm";
			case 37809: return useSRGBBuffer ? "astc-5x4-unorm-srgb" : "astc-5x4-unorm";
			case 37810: return useSRGBBuffer ? "astc-5x5-unorm-srgb" : "astc-5x5-unorm";
			case 37811: return useSRGBBuffer ? "astc-6x5-unorm-srgb" : "astc-6x5-unorm";
			case 37812: return useSRGBBuffer ? "astc-6x6-unorm-srgb" : "astc-6x6-unorm";
			case 37813: return useSRGBBuffer ? "astc-8x5-unorm-srgb" : "astc-8x5-unorm";
			case 37814: return useSRGBBuffer ? "astc-8x6-unorm-srgb" : "astc-8x6-unorm";
			case 37815: return useSRGBBuffer ? "astc-8x8-unorm-srgb" : "astc-8x8-unorm";
			case 37816: return useSRGBBuffer ? "astc-10x5-unorm-srgb" : "astc-10x5-unorm";
			case 37817: return useSRGBBuffer ? "astc-10x6-unorm-srgb" : "astc-10x6-unorm";
			case 37818: return useSRGBBuffer ? "astc-10x8-unorm-srgb" : "astc-10x8-unorm";
			case 37819: return useSRGBBuffer ? "astc-10x10-unorm-srgb" : "astc-10x10-unorm";
			case 37820: return useSRGBBuffer ? "astc-12x10-unorm-srgb" : "astc-12x10-unorm";
			case 37821: return useSRGBBuffer ? "astc-12x12-unorm-srgb" : "astc-12x12-unorm";
			case 36196:
			case 37492: return useSRGBBuffer ? "etc2-rgb8unorm-srgb" : "etc2-rgb8unorm";
			case 37496: return useSRGBBuffer ? "etc2-rgba8unorm-srgb" : "etc2-rgba8unorm";
		}
		switch (type) {
			case 3: switch (format) {
				case 6: return "r8snorm";
				case 7: return "rg8snorm";
				case 4: throw "RGB format not supported in WebGPU";
				case 8: return "r8sint";
				case 9: return "rg8sint";
				case 10: throw "RGB_INTEGER format not supported in WebGPU";
				case 11: return "rgba8sint";
				default: return "rgba8snorm";
			}
			case 0: switch (format) {
				case 6: return "r8unorm";
				case 7: return "rg8unorm";
				case 4: throw "TEXTUREFORMAT_RGB format not supported in WebGPU";
				case 5: return useSRGBBuffer ? "rgba8unorm-srgb" : "rgba8unorm";
				case 12: return useSRGBBuffer ? "bgra8unorm-srgb" : "bgra8unorm";
				case 8: return "r8uint";
				case 9: return "rg8uint";
				case 10: throw "RGB_INTEGER format not supported in WebGPU";
				case 11: return "rgba8uint";
				case 0: throw "TEXTUREFORMAT_ALPHA format not supported in WebGPU";
				case 1: throw "TEXTUREFORMAT_LUMINANCE format not supported in WebGPU";
				case 2: throw "TEXTUREFORMAT_LUMINANCE_ALPHA format not supported in WebGPU";
				default: return "rgba8unorm";
			}
			case 4: switch (format) {
				case 8: return "r16sint";
				case 9: return "rg16sint";
				case 10: throw "TEXTUREFORMAT_RGB_INTEGER format not supported in WebGPU";
				case 11: return "rgba16sint";
				default: return "rgba16sint";
			}
			case 5: switch (format) {
				case 8: return "r16uint";
				case 9: return "rg16uint";
				case 10: throw "TEXTUREFORMAT_RGB_INTEGER format not supported in WebGPU";
				case 11: return "rgba16uint";
				default: return "rgba16uint";
			}
			case 6: switch (format) {
				case 8: return "r32sint";
				case 9: return "rg32sint";
				case 10: throw "TEXTUREFORMAT_RGB_INTEGER format not supported in WebGPU";
				case 11: return "rgba32sint";
				default: return "rgba32sint";
			}
			case 7: switch (format) {
				case 8: return "r32uint";
				case 9: return "rg32uint";
				case 10: throw "TEXTUREFORMAT_RGB_INTEGER format not supported in WebGPU";
				case 11: return "rgba32uint";
				default: return "rgba32uint";
			}
			case 1: switch (format) {
				case 6: return "r32float";
				case 7: return "rg32float";
				case 4: throw "TEXTUREFORMAT_RGB format not supported in WebGPU";
				case 5: return "rgba32float";
				default: return "rgba32float";
			}
			case 2: switch (format) {
				case 6: return "r16float";
				case 7: return "rg16float";
				case 4: throw "TEXTUREFORMAT_RGB format not supported in WebGPU";
				case 5: return "rgba16float";
				default: return "rgba16float";
			}
			case 10: throw "TEXTURETYPE_UNSIGNED_SHORT_5_6_5 format not supported in WebGPU";
			case 13: switch (format) {
				case 5: return "rg11b10ufloat";
			...
			case 14: switch (format) {
				case 5: return "rgb9e5ufloat";
				...
				default: return "rgb9e5ufloat";
			}
			case 8: throw "TEXTURETYPE_UNSIGNED_SHORT_4_4_4_4 format not supported in WebGPU";
			case 9: throw "TEXTURETYPE_UNSIGNED_SHORT_5_5_5_1 format not supported in WebGPU";
			case 11: switch (format) {
				case 5: return "rgb10a2unorm";
				case 11: return "rgb10a2uint";
				default: return "rgb10a2unorm";
			}
		}
	...
	static GetNumChannelsFromWebGPUTextureFormat(format) {
		switch (format) {
			...
			case "eac-rg11unorm":
			case "eac-rg11snorm": return 2;
			case "rgb9e5ufloat":
			case "rg11b10ufloat":
			case "bc6h-rgb-ufloat":
			case "bc6h-rgb-float":
			case "etc2-rgb8unorm":
			case "etc2-rgb8unorm-srgb": return 3;
			case "rgba8unorm":
			case "rgba8unorm-srgb":
			case "rgba8snorm":
			case "rgba8uint":
			...
			case "astc-12x10-unorm-srgb":
			case "astc-12x12-unorm":
			case "astc-12x12-unorm-srgb": return 4;
		}
	...
	static HasStencilAspect(format) {
		switch (format) {
			case "stencil8":
			case "depth32float-stencil8":
			case "depth24plus-stencil8": return true;
		}
		return false;
	}
	static HasDepthAspect(format) {
		switch (format) {
			...
			case "depth24plus-stencil8":
			case "depth32float":
			case "depth32float-stencil8": return true;
		}
		return false;
	}
	...
	static GetDepthFormatOnly(format) {
		switch (format) {
			...
			case "depth24plus-stencil8": return "depth24plus";
			case "depth32float": return "depth32float";
			case "depth32float-stencil8": return "depth32float";
		}
		return format;
	}
...
//#endregion
//#region node_modules/@babylonjs/core/Engines/thinWebGPUEngine.js
/**
...
var ThinWebGPUEngine = class extends AbstractEngine {
	...
	*/
	...
	set enableGPUTimingMeasurements(enable) {
		if (this._timestampQuery.enable === enable) return;
	...
	*/
	_generateMipmaps(texture, commandEncoder) {
		...
		if (!gpuHardwareTexture) return;
		if (commandEncoder === this._renderEncoder) this._endCurrentRenderPass();
		const mipmapCount = WebGPUTextureHelper.ComputeNumMipmapLevels(texture.width, texture.height);
		if (texture.isCube) this._textureHelper.generateCubeMipmaps(gpuHardwareTexture, mipmapCount, commandEncoder);
		else if (texture._source === 3 || texture._source === 11) this._textureHelper.generateMipmaps(gpuHardwareTexture, texture.mipLevelCount, 0, commandEncoder);
		else this._textureHelper.generateMipmaps(gpuHardwareTexture, mipmapCount, 0, commandEncoder);
	}
	_debugPopBeforeEndOfEncoder() {
		if (!this._enableGPUDebugMarkers) return;
		...
		for (let i = groups.length - 1; i >= 0; --i) {
			if (this._showGPUDebugMarkersLog) Logger.Log(`[${this.frameId}] [E${this._debugMarkersEncoderGroups.length}|P${this._debugMarkersPassGroups.length}] [automatic] Popping debug group '${groups[i]}' on '${target.label}'.`);
	...
	_debugPushAfterStartOfEncoder() {
		...
		for (const groupName of groups) {
			if (this._showGPUDebugMarkersLog) Logger.Log(`[${this.frameId}] [E${this._debugMarkersEncoderGroups.length}|P${this._debugMarkersPassGroups.length}] [automatic] Pushing debug group '${groupName}' on '${target.label}'.`);
	...
	_debugPendingPop(currentRenderPass) {
		...
		while (this._debugMarkersPendingEncoderPops-- > 0) {
			...
			if (this._showGPUDebugMarkersLog) Logger.Log(`[${this.frameId}] [E${this._debugMarkersEncoderGroups.length}|P${this._debugMarkersPassGroups.length}] [automatic] Popping debug group '${groupName}' on render encoder '${this._renderEncoder.label}' after the end of render pass '${currentRenderPass.label}'.`);
...
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGPU/Extensions/engine.alpha.js
...
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGPU/webgpuConstants.js
/** @internal */
var PowerPreference;
...
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGPU/webgpuShaderProcessor.js
/** @internal */
var WebGPUShaderProcessor = class WebGPUShaderProcessor {
	constructor() {
	...
	_addUniformToLeftOverUBO(name, uniformType, preProcessors) {
		...
		for (let i = 0; i < this._webgpuProcessingContext.leftOverUniforms.length; i++) if (this._webgpuProcessingContext.leftOverUniforms[i].name === name) return;
	...
	_buildLeftOverUBO() {
		if (!this._webgpuProcessingContext.leftOverUniforms.length) return "";
		const name = WebGPUShaderProcessor.LeftOvertUBOName;
		let availableUBO = this._webgpuProcessingContext.availableBuffers[name];
		if (!availableUBO) {
			availableUBO = { binding: this._webgpuProcessingContext.getNextFreeUBOBinding() };
	...
	_collectBindingNames() {
		for (let i = 0; i < this._webgpuProcessingContext.bindGroupLayoutEntries.length; i++) {
			...
			for (let j = 0; j < setDefinition.length; j++) {
				...
				if (entry) {
					if (entry.texture || entry.externalTexture || entry.storageTexture) this._webgpuProcessingContext.textureNames.push(nameInArrayOfTexture);
					else if (entry.sampler) this._webgpuProcessingContext.samplerNames.push(name);
					else if (entry.buffer) this._webgpuProcessingContext.bufferNames.push(name);
				}
			}
		}
	}
	_preCreateBindGroupEntries() {
		...
		for (let i = 0; i < this._webgpuProcessingContext.bindGroupLayoutEntries.length; i++) {
			...
			for (let j = 0; j < setDefinition.length; j++) {
				const entry = this._webgpuProcessingContext.bindGroupLayoutEntries[i][j];
				if (entry.sampler || entry.texture || entry.storageTexture || entry.externalTexture) entries.push({
					binding: entry.binding,
					resource: void 0
				});
				else if (entry.buffer) entries.push({
					binding: entry.binding,
					resource: {
						buffer: void 0,
						offset: 0,
	...
	_addTextureBindingDescription(name, textureInfo, textureIndex, dimension, format, isVertex, storageTextureAccess = "write-only") {
		...
		if (!this._webgpuProcessingContext.bindGroupLayoutEntryInfo[groupIndex][bindingIndex]) {
			let len;
			if (dimension === null) len = this._webgpuProcessingContext.bindGroupLayoutEntries[groupIndex].push({
				binding: bindingIndex,
				visibility: 0,
				externalTexture: {}
			});
			else if (format) len = this._webgpuProcessingContext.bindGroupLayoutEntries[groupIndex].push({
				binding: bindingIndex,
				visibility: 0,
				storageTexture: {
			...
			else len = this._webgpuProcessingContext.bindGroupLayoutEntries[groupIndex].push({
				binding: bindingIndex,
				visibility: 0,
				texture: {
		...
		if (isVertex) this._webgpuProcessingContext.bindGroupLayoutEntries[groupIndex][bindingIndex].visibility |= 1;
		else this._webgpuProcessingContext.bindGroupLayoutEntries[groupIndex][bindingIndex].visibility |= 2;
	}
...
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGPU/webgpuPipelineContext.js
/** @internal */
var WebGPUPipelineContext = class {
	...
	**/
	dispose() {
		if (this.uniformBuffer) this.uniformBuffer.dispose();
	}
	/**
	...
	*/
	setInt(uniformName, value) {
		if (!this.uniformBuffer || !this._leftOverUniformsByName[uniformName]) return;
...
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGPU/webgpuShaderProcessingContext.js
var MaxGroups = 4;
var MaxBindingsPerGroup = 65536;
...
* @internal
*/
var WebGPUShaderProcessingContext = class WebGPUShaderProcessingContext {
	...
	constructor(shaderLanguage, pureMode = false) {
		...
		if (!pureMode) this._findStartingGroupBinding();
	}
	_findStartingGroupBinding() {
		...
		for (const name in knownUBOs) {
			...
			if (binding.groupIndex === -1) continue;
			if (groups[binding.groupIndex] === void 0) groups[binding.groupIndex] = binding.bindingIndex;
			else groups[binding.groupIndex] = Math.max(groups[binding.groupIndex], binding.bindingIndex);
		}
		this.freeGroupIndex = groups.length - 1;
		if (this.freeGroupIndex === 0) {
			this.freeGroupIndex++;
			this.freeBindingIndex = 0;
		} else this.freeBindingIndex = groups[groups.length - 1] + 1;
	}
	...
	_getNextFreeBinding(bindingCount) {
		...
		if (this.freeGroupIndex === MaxGroups) throw "Too many textures or UBOs have been declared and it is not supported in WebGPU.";
		const returnValue = {
...
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGPU/webgpuShaderProcessorsGLSL.js
/** @internal */
var WebGPUShaderProcessorGLSL = class extends WebGPUShaderProcessor {
	...
	_getArraySize(name, type, preProcessors) {
		...
		if (startArray > 0 && endArray > 0) {
			...
			if (isNaN(length)) length = +preProcessors[lengthInString.trim()];
	...
	preProcessShaderCode(code, isFragment) {
		...
		if (isFragment) {
			...
			if (this._fragmentIsGLES3) this.varyingFragmentKeywordName = "in";
	...
	varyingCheck(varying, isFragment) {
		return (isFragment && this._fragmentIsGLES3 ? /(flat\s)?\s*\bin\b/ : !isFragment && this._vertexIsGLES3 ? /(flat\s)?\s*\bout\b/ : /(flat\s)?\s*\bvarying\b/).test(varying);
	}
	varyingProcessor(varying, isFragment, preProcessors) {
		this._preProcessors = preProcessors;
		const match = (isFragment && this._fragmentIsGLES3 ? /\s*(flat)?\s*in\s+(?:(?:highp)?|(?:lowp)?)\s*(\S+)\s+(\S+)\s*;/gm : !isFragment && this._vertexIsGLES3 ? /\s*(flat)?\s*out\s+(?:(?:highp)?|(?:lowp)?)\s*(\S+)\s+(\S+)\s*;/gm : /\s*(flat)?\s*varying\s+(?:(?:highp)?|(?:lowp)?)\s*(\S+)\s+(\S+)\s*;/gm).exec(varying);
		if (match !== null) {
			...
			if (isFragment) {
				...
				if (location === void 0) Logger.Warn(`Invalid fragment shader: The varying named "${name}" is not declared in the vertex shader! This declaration will be ignored.`);
			} else {
	...
	attributeProcessor(attribute, preProcessors) {
		this._preProcessors = preProcessors;
		const match = (this._vertexIsGLES3 ? /\s*in\s+(\S+)\s+(\S+)\s*;/gm : /\s*attribute\s+(\S+)\s+(\S+)\s*;/gm).exec(attribute);
		if (match !== null) {
			...
			} else attribute = attribute.replace(match[0], `layout(location = ${location}) in ${attributeType} ${name};`);
		}
		return attribute;
	}
	uniformProcessor(uniform, isFragment, preProcessors) {
		this._preProcessors = preProcessors;
		const match = /\s*uniform\s+(?:(?:highp)?|(?:lowp)?)\s*(\S+)\s+(\S+)\s*;/gm.exec(uniform);
		if (match !== null) {
			...
			if (uniformType.indexOf("sampler") === 0 || uniformType.indexOf("sampler") === 1) {
				...
				if (!textureInfo) {
					...
					for (let i = 0; i < (arraySize || 1); ++i) textureInfo.textures.push(this._webgpuProcessingContext.getNextFreeUBOBinding());
				}
				...
				if (!samplerInfo) samplerInfo = {
					binding: this._webgpuProcessingContext.getNextFreeUBOBinding(),
					type: samplerBindingType
				};
				const componentType = uniformType.charAt(0) === "u" ? "u" : uniformType.charAt(0) === "i" ? "i" : "";
				if (componentType) uniformType = uniformType.substring(1);
				textureInfo.sampleType = isComparisonSampler ? "depth" : componentType === "u" ? "uint" : componentType === "i" ? "sint" : "float";
				...
				for (let i = 0; i < arraySize; ++i) this._addTextureBindingDescription(name, textureInfo, i, textureDimension, null, !isFragment);
			} else {
	...
	uniformBufferProcessor(uniformBuffer, isFragment) {
		const match = /uniform\s+(\w+)/gm.exec(uniformBuffer);
		if (match !== null) {
			const name = match[1];
			...
			if (!uniformBufferInfo) {
				...
				let binding;
				if (knownUBO && knownUBO.binding.groupIndex !== -1) binding = knownUBO.binding;
				else binding = this._webgpuProcessingContext.getNextFreeUBOBinding();
	...
	postProcessor(code, defines, isFragment, _processingContext, _parameters, preProcessors) {
		...
		if (isFragment) {
			...
			if (!this._fragmentIsGLES3) code = code.replace(/void\s+?main\s*\(/g, (hasDrawBuffersExtension || hasOutput ? "" : "layout(location = 0) out vec4 glFragColor;\n") + "void main(");
			else {
				const match = /^\s*out\s+\S+\s+\S+\s*;/gm.exec(code);
				if (match !== null) code = code.substring(0, match.index) + "layout(location = 0) " + code.substring(match.index);
			}
			code = code.replace(/dFdy/g, "(-yFactor_)*dFdy");
			code = code.replace("##INJECTCODE##", injectCode);
			if (hasFragCoord) code = InjectStartingAndEndingCode(code, "void main", fragCoordCode);
		} else {
			if ("VERTEXOUTPUT_INVARIANT" in preProcessors) code = "invariant gl_Position;\n" + code;
	...
	_applyTextureArrayProcessing(code, name) {
		...
		while (match !== null) {
			const index = match[1];
			let iindex = +index;
			if (this._preProcessors && isNaN(iindex)) iindex = +this._preProcessors[index.trim()];
	...
	finalizeShaders(vertexCode, fragmentCode) {
		...
		for (let i = 0; i < this._missingVaryings.length; ++i) {
			...
			if (decl && decl.length > 0) fragmentCode = decl + "\n" + fragmentCode;
		}
...
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGPU/webgpuShaderProcessorsWGSL.js
...
var WebGPUShaderProcessorWGSL = class extends WebGPUShaderProcessor {
	...
	_getArraySize(name, uniformType, preProcessors) {
		...
		if (uniformType.indexOf("array") >= 0 && endArray > 0) {
			...
			while (startArray > 0 && uniformType.charAt(startArray) !== " " && uniformType.charAt(startArray) !== ",") startArray--;
	...
	preProcessShaderCode(code) {
		...
		return code.indexOf(ubDeclaration) !== -1 ? code : ubDeclaration + RemoveComments(code);
	}
	varyingCheck(varying) {
		return /(flat|linear|perspective)?\s*(center|centroid|sample)?\s*\bvarying\b/.test(varying);
	}
	varyingProcessor(varying, isFragment, preProcessors) {
		const match = /\s*(flat|linear|perspective)?\s*(center|centroid|sample)?\s*varying\s+(?:(?:highp)?|(?:lowp)?)\s*(\S+)\s*:\s*(.+)\s*;/gm.exec(varying);
		if (match !== null) {
	...
	attributeProcessor(attribute, preProcessors) {
		const match = /\s*attribute\s+(\S+)\s*:\s*(.+)\s*;/gm.exec(attribute);
		if (match !== null) {
	...
	textureProcessor(texture, isFragment, preProcessors) {
		...
		if (match !== null) {
			...
			if (isStorageTexture) {
				...
				switch (componentType.substring(commaIndex + 1).trim()) {
					case "read":
			...
			if (!textureInfo) {
				...
				for (let i = 0; i < arraySize; ++i) textureInfo.textures.push(this._webgpuProcessingContext.getNextFreeUBOBinding());
			} else arraySize = textureInfo.textures.length;
			this._webgpuProcessingContext.availableTextures[name] = textureInfo;
			...
			textureInfo.sampleType = isDepthTexture ? "depth" : componentType === "u32" ? "uint" : componentType === "i32" ? "sint" : "float";
			if (textureDimension === void 0) throw `Can't get the texture dimension corresponding to the texture function "${textureFunc}"!`;
			for (let i = 0; i < arraySize; ++i) {
				const { groupIndex, bindingIndex } = textureInfo.textures[i];
				if (i === 0) texture = `@group(${groupIndex}) @binding(${bindingIndex}) ${texture}`;
	...
	_convertDefinesToConst(preProcessors) {
		...
		for (const key in preProcessors) {
			...
			if (!isNaN(parseInt(value)) || !isNaN(parseFloat(value))) code += `const ${key} = ${value};\n`;
	...
	postProcessor(code, _defines, _isFragment, _processingContext, _parameters, preProcessors, preProcessorsFromCode) {
		const defineList = [];
		for (const key in preProcessorsFromCode) if (preProcessorsFromCode[key] !== "true") defineList.push(key);
		...
		if ("VERTEXOUTPUT_INVARIANT" in preProcessors) code = "#define VERTEXOUTPUT_INVARIANT\n" + code;
		return code;
	}
	finalizeShaders(vertexCode, fragmentCode) {
		...
		if (!this.pureMode) fragmentCode = fragmentCode.replace(/dpdy/g, "(-internals.yFactor_)*dpdy");
		...
		match = fragmentCode.match(/oitDepthSampler/);
		if (match) {
		...
		if (indexLocation === 0) if (fragmentCode.indexOf("DUAL_SOURCE_BLENDING") !== -1) {
		...
		if (hasFragDepth) fragmentOutputs += "  @builtin(frag_depth) fragDepth: f32,\n";
		...
		if (enabledExtensions.length > 0) fragmentCode = "enable " + enabledExtensions.join(";\nenable ") + ";\n" + fragmentCode;
	...
	_generateLeftOverUBOCode(name, uniformBufferDescription) {
		...
		for (const leftOverUniform of this._webgpuProcessingContext.leftOverUniforms) {
			const type = leftOverUniform.type.replace(/^(.*?)(<.*>)?$/, "$1");
			const size = WebGPUShaderProcessor.UniformSizes[type];
			if (leftOverUniform.length > 0) if (size <= 2) {
	...
	_processSamplers(code, isVertex) {
		...
		while (true) {
			...
			if (textureName) {
				...
				if (textureInfo) textureInfo.autoBindSampler = true;
			}
			...
			if (!bufferInfo) {
				...
				if (knownUBO) {
					...
					if (binding.groupIndex === -1) {
						...
						if (!binding) binding = this._webgpuProcessingContext.getNextFreeUBOBinding();
					}
				} else binding = this._webgpuProcessingContext.getNextFreeUBOBinding();
				bufferInfo = { binding };
	...
	_processStridedUniformArrays(code) {
		for (const uniformArrayName of this._stridedUniformArrays) code = code.replace(new RegExp(`${uniformArrayName}\\s*\\[(.*?)\\]`, "g"), `${uniformArrayName}[$1].el`);
		return code;
	}
};
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGPU/webgpuHardwareTexture.js
/** @internal */
var WebGPUHardwareTexture = class {
	...
	getMSAATexture(sampleCount, index = 0) {
		if (!this._webgpuMSAATexture[index]) this._createMSAATexture(sampleCount, index);
		return this._webgpuMSAATexture[index];
	}
	releaseMSAATextures() {
		for (const texture of this._webgpuMSAATexture) if (texture) this._engine._textureHelper.releaseTexture(texture);
	...
	_createMSAATexture(samples, index) {
		if (!this._webgpuTexture) throw new Error("Cannot create GPU MSAA texture because underlying GPU texture is not created yet.");
		if (!this._webgpuMSAATexture) this._webgpuMSAATexture = [];
...
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGPU/webgpuTextureManager.js
...
var WebGPUTextureManager = class {
	constructor(engine, device, bufferManager, enabledExtensions) {
		...
		if (enabledExtensions.indexOf("rg11b10ufloat-renderable") !== -1) {
			const keys = Object.keys(renderableTextureFormatToIndex);
			renderableTextureFormatToIndex["rg11b10ufloat"] = renderableTextureFormatToIndex[keys[keys.length - 1]] + 1;
		}
		this._mipmapSampler = device.createSampler({ minFilter: "linear" });
		this._videoSampler = device.createSampler({ minFilter: "linear" });
		this._ubCopyWithOfst = this._bufferManager.createBuffer(16, BufferUsage.Uniform | BufferUsage.CopyDst, "UBCopyWithOffset").underlyingResource;
		this._getPipeline("rgba8unorm");
		this._getVideoPipeline("rgba8unorm");
	}
	_getPipeline(format, type = PipelineType.MipMap, params) {
		const index = type === PipelineType.MipMap ? 1 : type === PipelineType.InvertYPremultiplyAlpha ? ((params.invertY ? 1 : 0) << 1) + ((params.premultiplyAlpha ? 1 : 0) << 2) : type === PipelineType.Clear ? 8 : type === PipelineType.InvertYPremultiplyAlphaWithOfst ? ((params.invertY ? 1 : 0) << 4) + ((params.premultiplyAlpha ? 1 : 0) << 5) : type === PipelineType.ResolveDepth ? 64 : 0;
		if (!this._pipelines[format]) this._pipelines[format] = [];
		...
		if (!pipelineAndBGL) {
			...
			if (type === PipelineType.InvertYPremultiplyAlpha || type === PipelineType.InvertYPremultiplyAlphaWithOfst) {
				if (params.invertY) defines += "#define INVERTY\n";
			...
			if (!modules) {
				...
				const processorOptions = {
					...
					processor: this._engine._getShaderProcessor(1),
	...
	_getVideoPipeline(format, type = VideoPipelineType.DontInvertY) {
		const index = type === VideoPipelineType.InvertY ? 1 : 0;
		if (!this._videoPipelines[format]) this._videoPipelines[format] = [];
	...
	copyVideoToTexture(video, texture, format, invertY = false, commandEncoder) {
		...
		const descriptor = {
			...
			entries: [{
				...
				binding: 1,
				resource: this._device.importExternalTexture({ source: video.underlyingResource })
			}]
		};
	...
	invertYPreMultiplyAlpha(gpuOrHdwTexture, width, height, format, invertY = false, premultiplyAlpha = false, faceIndex = 0, mipLevel = 0, layers = 1, ofstX = 0, ofstY = 0, rectWidth = 0, rectHeight = 0, commandEncoder, allowGPUOptimization) {
		...
		if (WebGPUTextureHelper.IsHardwareTexture(gpuOrHdwTexture)) {
			...
			if (!(invertY && !premultiplyAlpha && layers === 1 && faceIndex === 0)) gpuOrHdwTexture = void 0;
		} else {
		...
		if (useRect) this._bufferManager.setRawData(this._ubCopyWithOfst, 0, new Float32Array([
			ofstX,
			ofstY,
			rectWidth,
			rectHeight
		...
		const outputTexture = webgpuHardwareTexture?._copyInvertYTempTexture ?? this.createTexture({
			...
			height,
			layers: 1
		}, false, false, false, false, false, format, 1, commandEncoder, 21, void 0, "TempTextureForCopyWithInvertY");
		...
		if (!bindGroup) {
			...
			if (useRect) descriptor.entries.push({
				binding: 1,
				resource: { buffer: this._ubCopyWithOfst }
			});
		...
		passEncoder.draw(4, 1, 0, 0);
		passEncoder.end();
		commandEncoder.copyTextureToTexture({ texture: outputTexture }, {
			texture: gpuTexture,
			mipLevel,
			origin: {
				x: 0,
		...
		if (webgpuHardwareTexture) {
			...
			if (useRect) webgpuHardwareTexture._copyInvertYBindGroupWithOfst = bindGroup;
			else webgpuHardwareTexture._copyInvertYBindGroup = bindGroup;
		} else this._deferredReleaseTextures.push([outputTexture, null]);
		commandEncoder.popDebugGroup();
		if (useOwnCommandEncoder) {
			this._device.queue.submit([commandEncoder.finish()]);
			commandEncoder = null;
	...
	createTexture(imageBitmap, hasMipmaps = false, generateMipmaps = false, invertY = false, premultiplyAlpha = false, is3D = false, format = "rgba8unorm", sampleCount = 1, commandEncoder, usage = -1, additionalUsages = 0, label, mipLevelCount) {
		...
		const usages = usage >= 0 ? usage : 7;
		additionalUsages |= hasMipmaps && !isCompressedFormat ? 1 | renderAttachmentFlag : 0;
		if (!isCompressedFormat && !is3D) additionalUsages |= renderAttachmentFlag | 2;
		...
		if (WebGPUTextureHelper.IsImageBitmap(imageBitmap)) {
			...
			if (hasMipmaps && generateMipmaps) this.generateMipmaps(gpuTexture, effectiveMipLevelCount, 0, commandEncoder);
		}
		return gpuTexture;
	}
	createCubeTexture(imageBitmaps, hasMipmaps = false, generateMipmaps = false, invertY = false, premultiplyAlpha = false, format = "rgba8unorm", sampleCount = 1, commandEncoder, usage = -1, additionalUsages = 0, label) {
		...
		const usages = usage >= 0 ? usage : 7;
		additionalUsages |= hasMipmaps && !isCompressedFormat ? 1 | renderAttachmentFlag : 0;
		if (!isCompressedFormat) additionalUsages |= renderAttachmentFlag | 2;
		const gpuTexture = this._device.createTexture({
		...
		if (WebGPUTextureHelper.IsImageBitmapArray(imageBitmaps)) {
			...
			if (hasMipmaps && generateMipmaps) this.generateCubeMipmaps(gpuTexture, mipLevelCount, commandEncoder);
		}
		return gpuTexture;
	}
	generateCubeMipmaps(gpuOrHdwTexture, mipLevelCount, commandEncoder) {
		...
		for (let f = 0; f < gpuTexture.depthOrArrayLayers; ++f) this.generateMipmaps(gpuOrHdwTexture, mipLevelCount, f, commandEncoder);
		commandEncoder.popDebugGroup();
		if (useOwnCommandEncoder) {
			this._device.queue.submit([commandEncoder.finish()]);
			commandEncoder = null;
	...
	createGPUTextureForInternalTexture(texture, width, height, depth, creationFlags) {
		if (!texture._hardwareTexture) texture._hardwareTexture = new WebGPUHardwareTexture(this._engine);
		if (width === void 0) width = texture.width;
		if (height === void 0) height = texture.height;
		if (depth === void 0) depth = texture.depth;
		...
		if (texture.samples > 1) switch (gpuTextureWrapper.format) {
			case "depth16unorm":
		...
		gpuTextureWrapper.textureUsages = texture._source === 5 || texture.source === 6 ? 21 : texture._source === 12 ? 20 : -1;
		...
		let mipmapCount;
		if (texture._maxLodLevel !== null) mipmapCount = texture._maxLodLevel;
		else mipmapCount = hasMipMaps ? WebGPUTextureHelper.ComputeNumMipmapLevels(width, height) : 1;
		if (texture.isCube) {
			const gpuTexture = this.createCubeTexture({
				width,
				height,
				layers: layerCount
			}, texture.generateMipMaps, texture.generateMipMaps, texture.invertY, false, gpuTextureWrapper.format, 1, this._commandEncoderForCreation, gpuTextureWrapper.textureUsages, gpuTextureWrapper.textureAdditionalUsages, label);
			...
			const gpuTexture = this.createTexture({
				...
				height,
				layers: layerCount
			}, hasMipMaps, texture.generateMipMaps, texture.invertY, false, texture.is3D, gpuTextureWrapper.format, 1, this._commandEncoderForCreation, gpuTextureWrapper.textureUsages, gpuTextureWrapper.textureAdditionalUsages, label);
			gpuTextureWrapper.set(gpuTexture);
	...
	createMSAATexture(gpuTexture, format, samples) {
		return this.createTexture({
			...
			layers: 1
		}, false, false, false, false, false, format, samples, this._commandEncoderForCreation, 20, 0, gpuTexture.label ? gpuTexture.label + " (MSAA)" : "MSAA");
	}
	...
	updateTexture(imageBitmap, texture, width, height, layers, format, faceIndex = 0, mipLevel = 0, invertY = false, premultiplyAlpha = false, offsetX = 0, offsetY = 0, allowGPUOptimization) {
		...
		if (imageBitmap.byteLength !== void 0) {
			...
			if (Math.ceil(bytesPerRow / 256) * 256 === bytesPerRow) {
			...
			} else this._device.queue.writeTexture(textureCopyView, imageBitmap, {
				offset: 0,
				bytesPerRow,
				rowsPerImage: textureExtent.height / blockInformation.height
			}, textureExtent);
			if (invertY || premultiplyAlpha) if (WebGPUTextureHelper.IsInternalTexture(texture)) {
			...
			} else throw "updateTexture: Can't process the texture data because a GPUTexture was provided instead of an InternalTexture!";
		} else {
			imageBitmap = imageBitmap;
	...
	updateMipLevelCountForInternalTexture(texture, mipLevelCount) {
		...
		if (mipLevelCount !== void 0) texture.mipLevelCount = Math.min(Math.max(1, mipLevelCount), maxNumMipLevels);
		else if (texture.generateMipMaps) texture.mipLevelCount = maxNumMipLevels;
		else texture.mipLevelCount = 1;
	}
	...
	releaseTexture(texture) {
		...
		} else this._deferredReleaseTextures.push([texture, null]);
	}
	destroyDeferredTextures() {
		for (let i = 0; i < this._deferredReleaseTextures.length; ++i) {
			...
			if (hardwareTexture) if (WebGPUTextureHelper.IsHardwareTexture(hardwareTexture)) hardwareTexture.release();
			else hardwareTexture.destroy();
...
//#endregion
//#region node_modules/@babylonjs/core/Meshes/WebGPU/webgpuDataBuffer.js
/** @internal */
var WebGPUDataBuffer = class extends DataBuffer {
	...
	constructor(resource, capacity = 0) {
		...
		if (resource) this._buffer = resource;
	}
	/** @internal */
	get underlyingResource() {
		return this._buffer;
...
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGPU/webgpuBufferManager.js
/** @internal */
var WebGPUBufferManager = class WebGPUBufferManager {
	static _IsGPUBuffer(buffer) {
		return buffer.underlyingResource === void 0;
	}
	static _FlagsToString(flags, suffix = "") {
		let result = suffix;
		for (let i = 0; i <= 9; ++i) if (flags & 1 << i) {
			if (result) result += "_";
	...
	createRawBuffer(viewOrSize, flags, mappedAtCreation = false, label) {
		const alignedLength = viewOrSize.byteLength !== void 0 ? viewOrSize.byteLength + 3 & -4 : viewOrSize + 3 & -4;
	...
	createBuffer(viewOrSize, flags, label) {
		...
		dataBuffer.capacity = viewOrSize.byteLength !== void 0 ? viewOrSize.byteLength + 3 & -4 : viewOrSize + 3 & -4;
		dataBuffer.engineId = this._engine.uniqueId;
		if (isView) this.setSubData(dataBuffer, 0, viewOrSize);
		return dataBuffer;
	}
	...
	setSubData(dataBuffer, dstByteOffset, src, srcByteOffset = 0, byteLength = 0) {
		...
		if (src.buffer.byteLength - src.byteOffset < byteLength) {
	...
	_getHalfFloatAsFloatRGBAArrayBuffer(dataLength, arrayBuffer, destArray) {
		if (!destArray) destArray = new Float32Array(dataLength);
		else dataLength = Math.min(dataLength, destArray.length);
		const srcData = new Uint16Array(arrayBuffer);
		while (dataLength--) destArray[dataLength] = FromHalfFloat(srcData[dataLength]);
		return destArray;
	}
	readDataFromBuffer(gpuBuffer, size, width, height, bytesPerRow, bytesPerRowAligned, type = 0, offset = 0, buffer = null, destroyBuffer = true, noDataConversion = false) {
		...
		return new Promise((resolve, reject) => {
			gpuBuffer.mapAsync(1, offset, size).then(() => {
				...
				let data = buffer;
				if (noDataConversion) if (data === null) data = allocateAndCopyTypedBuffer(type, size, true, copyArrayBuffer);
				else data = allocateAndCopyTypedBuffer(type, data.buffer, void 0, copyArrayBuffer);
				else if (data === null) switch (floatFormat) {
					case 0:
				...
				if (bytesPerRow !== bytesPerRowAligned) {
					...
					for (let y = 1; y < height; ++y) {
						...
						for (let x = 0; x < bytesPerRow; ++x) data2[offset++] = data2[offset2++];
					}
					if (floatFormat !== 0 && !noDataConversion) data = new Float32Array(data2.buffer, 0, offset / 4);
					else data = new Uint8Array(data2.buffer, 0, offset);
				}
				gpuBuffer.unmap();
				if (destroyBuffer) this.releaseBuffer(gpuBuffer);
				resolve(data);
			}, (reason) => {
				if (this._engine.isDisposed || this._engine.uniqueId !== engineId) resolve(new Uint8Array());
				else reject(reason);
			});
		});
	}
	...
	destroyDeferredBuffers() {
		for (let i = 0; i < this._deferredReleaseBuffers.length; ++i) this._deferredReleaseBuffers[i].destroy();
		this._deferredReleaseBuffers.length = 0;
	}
};
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGPU/webgpuCacheSampler.js
/**
...
/** @internal */
var WebGPUCacheSampler = class WebGPUCacheSampler {
	constructor(device) {
		this._samplers = {};
		this._device = device;
		this.disabled = false;
	...
	static GetSamplerHashCode(sampler) {
		...
		return FilterToBits[sampler.samplingMode] + ComparisonFunctionToBits[(sampler._comparisonFunction || 514) - 512 + 1] + FilterNoMipToBits[sampler.samplingMode] + ((sampler._cachedWrapU ?? 1) << 8) + ((sampler._cachedWrapV ?? 1) << 10) + ((sampler._cachedWrapR ?? 1) << 12) + ((sampler.useMipMaps ? 1 : 0) << 14) + (anisotropy << 15);
	}
	static _GetSamplerFilterDescriptor(sampler, anisotropy) {
		...
		switch (sampler.samplingMode) {
			case 11:
				...
				if (!useMipMaps) lodMinClamp = lodMaxClamp = 0;
				break;
			case 3:
			case 3:
				magFilter = "linear";
			...
			case 2:
				magFilter = "linear";
				minFilter = "linear";
				if (anisotropy > 1) mipmapFilter = "linear";
				else {
					mipmapFilter = "nearest";
					lodMinClamp = lodMaxClamp = 0;
				}
		...
		if (anisotropy > 1 && (lodMinClamp !== 0 || lodMaxClamp !== 0)) return {
			magFilter: "linear",
			minFilter: "linear",
			mipmapFilter: "linear",
	...
	static _GetWrappingMode(mode) {
		switch (mode) {
			...
			case 0: return "clamp-to-edge";
			case 2: return "mirror-repeat";
		}
		return "repeat";
	}
	...
	static _GetSamplerDescriptor(sampler, label) {
		...
		if (sampler.samplingMode !== 11 && sampler.samplingMode !== 3 && sampler.samplingMode !== 2) anisotropy = 1;
	...
	static GetCompareFunction(compareFunction) {
		switch (compareFunction) {
			...
			case 518: return "greater-equal";
			case 513: return "less";
			case 515: return "less-equal";
			case 512: return "never";
			case 517: return "not-equal";
			default: return "less";
		}
	}
	getSampler(sampler, bypassCache = false, hash = 0, label) {
		if (this.disabled) return this._device.createSampler(WebGPUCacheSampler._GetSamplerDescriptor(sampler, label));
		if (bypassCache) hash = 0;
		else if (hash === 0) hash = WebGPUCacheSampler.GetSamplerHashCode(sampler);
		...
		if (!gpuSampler) {
			...
			if (!bypassCache) this._samplers[hash] = gpuSampler;
		}
		return gpuSampler;
	}
};
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGPU/webgpuCacheRenderPipeline.js
var StatePosition;
...
/** @internal */
var WebGPUCacheRenderPipeline = class WebGPUCacheRenderPipeline {
	...
	reset() {
		...
		this.setDepthBias(0);
		this._webgpuColorFormat = ["bgra8unorm"];
		this.setColorFormat("bgra8unorm");
		this.setMRT([]);
		...
		this.setDepthStencilFormat("depth24plus-stencil8");
	...
	*/
	...
	setMRTAttachments(attachments) {
		...
		let mask = 0;
		for (let i = 0; i < attachments.length; ++i) if (attachments[i] !== 0) mask += 1 << i;
	...
	setMRT(textureArray, textureCount) {
		...
		if (textureCount > 8) throw new Error("Can't handle more than 8 attachments for a MRT in cache render pipeline!");
		...
		let mask = 0;
		for (let i = 0; i < textureCount; ++i) {
			const gpuWrapper = textureArray[i]?._hardwareTexture;
	...
	static _GetTopology(fillMode) {
		switch (fillMode) {
			...
			case 2: return "point-list";
			case 1: return "line-list";
			case 3: return "point-list";
			case 4: return "line-list";
			case 5: throw "LineLoop is an unsupported fillmode in WebGPU";
			case 6: return "line-strip";
			case 7: return "triangle-strip";
			case 8: throw "TriangleFan is an unsupported fillmode in WebGPU";
	...
	static _GetAphaBlendOperation(operation) {
		switch (operation) {
			...
			case 32779: return "reverse-subtract";
	...
	static _GetAphaBlendFactor(factor) {
		switch (factor) {
			...
			case 1: return "one";
			case 768: return "src";
			case 769: return "one-minus-src";
			case 770: return "src-alpha";
			case 771: return "one-minus-src-alpha";
			case 772: return "dst-alpha";
			case 773: return "one-minus-dst-alpha";
			case 774: return "dst";
			case 775: return "one-minus-dst";
			case 776: return "src-alpha-saturated";
			case 32769:
			case 32771: return "constant";
			case 32770:
			case 32772: return "one-minus-constant";
			case 35065: return "src1";
			case 35066: return "one-minus-src1";
			case 34185: return "src1-alpha";
			case 35067: return "one-minus-src1-alpha";
			default: return "one";
		}
	}
	...
	static _GetStencilOpFunction(operation) {
		switch (operation) {
			...
			case 3: return "increment-clamp";
			case 4: return "decrement-clamp";
			case 5: return "invert";
			case 6: return "increment-wrap";
			case 7: return "decrement-wrap";
		}
		return "keep";
	}
	static _GetVertexInputDescriptorFormat(vertexBuffer) {
		...
		switch (type) {
			case VertexBuffer.BYTE:
				switch (size) {
					case 1:
					case 2: return normalized ? "snorm8x2" : "sint8x2";
					case 3:
					case 4: return normalized ? "snorm8x4" : "sint8x4";
				}
				break;
			case VertexBuffer.UNSIGNED_BYTE:
				switch (size) {
					case 1:
					case 2: return normalized ? "unorm8x2" : "uint8x2";
					case 3:
					case 4: return normalized ? "unorm8x4" : "uint8x4";
				}
				break;
			case VertexBuffer.SHORT:
				switch (size) {
					case 1:
					case 2: return normalized ? "snorm16x2" : "sint16x2";
					case 3:
					case 4: return normalized ? "snorm16x4" : "sint16x4";
				}
				break;
			case VertexBuffer.UNSIGNED_SHORT:
				switch (size) {
					case 1:
					case 2: return normalized ? "unorm16x2" : "uint16x2";
					case 3:
					case 4: return normalized ? "unorm16x4" : "uint16x4";
				}
				break;
			case VertexBuffer.INT:
				switch (size) {
	...
	_getAphaBlendState(targetIndex) {
		if (!this._alphaBlendEnabled[targetIndex]) return null;
		return {
	...
	_getColorBlendState(targetIndex) {
		if (!this._alphaBlendEnabled) return null;
		return {
	...
	_setDepthStencilState() {
		const stencilState = !this._stencilEnabled ? 2421327 : this._stencilFrontCompare + (this._stencilFrontDepthFailOp << 3) + (this._stencilFrontPassOp << 6) + (this._stencilFrontFailOp << 9) + (this._stencilBackCompare << 12) + (this._stencilBackDepthFailOp << 15) + (this._stencilBackPassOp << 18) + (this._stencilBackFailOp << 21);
		const depthStencilState = this._depthStencilFormat + ((this._depthTestEnabled ? this._depthCompare : 7) << 6) + stencilState * 1024;
	...
	_setVertexState(effect) {
		...
		for (let index = 0; index < attributes.length; index++) {
			...
			if (!vertexBuffer) {
				...
				if (WebGPUCacheRenderPipeline.LogErrorIfNoVertexBuffer) Logger.Error(`No vertex buffer is provided for the "${attributes[index]}" attribute. A default empty vertex buffer will be used, but this may generate errors in some browsers.`);
			}
		...
		if (this._isDirty) this._stateDirtyLowestIndex = Math.min(this._stateDirtyLowestIndex, StatePosition.VertexState);
	}
	...
	_createPipelineLayout(webgpuPipelineContext) {
		if (this._useTextureStage) return this._createPipelineLayoutWithTextureStage(webgpuPipelineContext);
		...
		for (let i = 0; i < bindGroupLayoutEntries.length; i++) {
			...
			bindGroupLayouts[i] = this._device.createBindGroupLayout({ entries: setDefinition });
		}
	...
	_createPipelineLayoutWithTextureStage(webgpuPipelineContext) {
			...
			for (let j = 0; j < setDefinition.length; j++) {
				...
				if (entry.texture) {
					...
					if (this._textureState & bitVal && sampleType !== "depth") {
						if (textureInfo.autoBindSampler) samplerType = "non-filtering";
		...
		const bindGroupLayouts = [];
		for (let i = 0; i < bindGroupLayoutEntries.length; ++i) bindGroupLayouts[i] = this._device.createBindGroupLayout({ entries: bindGroupLayoutEntries[i] });
	...
	_getVertexInputDescriptor(effect) {
		...
		for (let index = 0; index < attributes.length; index++) {
			const location = locations[index];
			let vertexBuffer = (this._overrideVertexBuffers && this._overrideVertexBuffers[attributes[index]]) ?? this._vertexBuffers[attributes[index]];
			if (!vertexBuffer) vertexBuffer = this._emptyVertexBuffer;
	...
	_buildRenderPipelineDescriptor(effect, topology, sampleCount) {
		...
		const colorStates = [];
		if (this._vertexBuffers) checkNonFloatVertexBuffers(this._vertexBuffers, effect);
		if (this._mrtAttachments > 0) for (let i = 0; i < this._mrtFormats.length; ++i) {
			...
			if (format) {
				...
				if (alphaBlend && colorBlend) descr.blend = {
					alpha: alphaBlend,
					color: colorBlend
				};
				colorStates.push(descr);
			} else colorStates.push(null);
		}
		...
		const stencilBack = {
			compare: WebGPUCacheRenderPipeline._GetCompareFunction(this._stencilEnabled ? this._stencilBackCompare : 7),
			depthFailOp: WebGPUCacheRenderPipeline._GetStencilOpFunction(this._stencilEnabled ? this._stencilBackDepthFailOp : 1),
			failOp: WebGPUCacheRenderPipeline._GetStencilOpFunction(this._stencilEnabled ? this._stencilBackFailOp : 1),
			passOp: WebGPUCacheRenderPipeline._GetStencilOpFunction(this._stencilEnabled ? this._stencilBackPassOp : 1)
		};
		const topologyIsTriangle = topology === "triangle-list" || topology === "triangle-strip";
		let stripIndexFormat = void 0;
		if (topology === "line-strip" || topology === "triangle-strip") stripIndexFormat = !this.indexBuffer || this.indexBuffer.is32Bits ? "uint32" : "uint16";
		...
		if (stripIndexFormat) primitiveState.stripIndexFormat = stripIndexFormat;
		return {
	...
	*/
	preWarmPipeline(fillMode, effect, sampleCount, textureState = 0) {
		sampleCount = WebGPUTextureHelper.GetSample(sampleCount);
		if (this._lookupRenderPipeline(fillMode, effect, sampleCount, textureState)) return null;
		const topology = WebGPUCacheRenderPipeline._GetTopology(fillMode);
		const capturedParam = {
			token: this._parameter.token,
			pipeline: null
		};
		return this._device.createRenderPipelineAsync(this._buildRenderPipelineDescriptor(effect, topology, sampleCount)).then((pipeline) => {
...
WebGPUCacheRenderPipeline._NumPipelineCreationCurrentFrame = 0;
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGPU/webgpuCacheRenderPipelineTree.js
/** @internal */
var NodeState = class {
	constructor() {
		this.values = {};
	...
	count() {
		...
		for (const value in this.values) {
			const [childCountNodes, childCoundPipeline] = this.values[value].count();
...
/** @internal */
var WebGPUCacheRenderPipelineTree = class WebGPUCacheRenderPipelineTree extends WebGPUCacheRenderPipeline {
...
WebGPUCacheRenderPipelineTree._Cache = new NodeState();
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGPU/webgpuStencilStateComposer.js
/**
* @internal
**/
...
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGPU/webgpuDepthCullingState.js
/**
* @internal
**/
...
//#endregion
//#region node_modules/@babylonjs/core/Materials/Textures/externalTexture.js
/**
...
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGPU/webgpuMaterialContext.js
/** @internal */
var WebGPUMaterialContext = class WebGPUMaterialContext {
	...
	setSampler(name, sampler) {
		...
		if (!samplerCache) this.samplers[name] = samplerCache = {
			sampler,
			hashCode: 0
		};
		else currentHashCode = samplerCache.hashCode;
		...
		if (isDirty) this.updateId++;
		this.isDirty || (this.isDirty = isDirty);
	}
	setTexture(name, texture) {
		let textureCache = this.textures[name];
		let currentTextureId = -1;
		if (!textureCache) this.textures[name] = textureCache = {
			texture,
			isFloatOrDepthTexture: false,
			isExternalTexture: false
		};
		else currentTextureId = textureCache.texture?.uniqueId ?? -1;
		if (textureCache.isExternalTexture) this._numExternalTextures--;
		if (textureCache.isFloatOrDepthTexture) this._numFloatOrDepthTextures--;
		if (texture) {
...
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGPU/webgpuDrawContext.js
/**
...
*/
var WebGPUDrawContext = class WebGPUDrawContext {
	/**
	...
	*/
	...
	set enableIndirectDraw(enable) {
		...
		if (this._enableIndirectDraw === enable) return;
	...
	set useInstancing(use) {
		if (this._useInstancing === use) return;
	...
	*/
	...
	setIndirectData(indexOrVertexCount, instanceCount, firstIndexOrVertex, forceUpdate = false) {
		if (!forceUpdate && instanceCount === this._currentInstanceCount || !this.indirectDrawBuffer || !this._indirectDrawData) return;
	...
	*/
	setVertexPulling(useVertexPulling, webgpuPipelineContext, vertexBuffers, indexBuffer, overrideVertexBuffers) {
		if (this._vertexPullingEnabled === useVertexPulling) return;
		this._vertexPullingEnabled = useVertexPulling;
		this._isDirty = true;
		const bufferNames = webgpuPipelineContext.shaderProcessingContext.bufferNames;
		if (overrideVertexBuffers) for (const attributeName in overrideVertexBuffers) {
			const vertexBuffer = overrideVertexBuffers[attributeName];
			if (!vertexBuffer || bufferNames.indexOf(attributeName) === -1) continue;
		...
		for (const attributeName in vertexBuffers) {
			if (overrideVertexBuffers && attributeName in overrideVertexBuffers) continue;
			const vertexBuffer = vertexBuffers[attributeName];
			if (!vertexBuffer || bufferNames.indexOf(attributeName) === -1) continue;
			const buffer = vertexBuffer.effectiveBuffer;
			this.setBuffer(attributeName, useVertexPulling ? buffer : null);
		}
		if (bufferNames.indexOf("indices") !== -1) this.setBuffer("indices", !useVertexPulling ? null : indexBuffer ?? this._dummyIndexBuffer);
	}
	dispose() {
...
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGPU/webgpuCacheBindGroups.js
/**
...
/** @internal */
var WebGPUCacheBindGroups = class WebGPUCacheBindGroups {
	...
	*/
	getBindGroups(webgpuPipelineContext, drawContext, materialContext) {
		...
		bindGroups = [];
		drawContext.bindGroups = bindGroups;
		if (!cacheIsDisabled) node.bindGroups = bindGroups;
			...
			for (let j = 0; j < setDefinition.length; j++) {
				...
				if (entry.sampler) {
					...
					if (bindingInfo) {
						...
						if (!sampler) {
							if (this._engine.dbgSanityChecks) Logger.Error(`Trying to bind a null sampler! entry=${JSON.stringify(entry)}, name=${name}, bindingInfo=${JSON.stringify(bindingInfo, (key, value) => key === "texture" ? "<no dump>" : value)}, materialContext.uniqueId=${materialContext.uniqueId}`, 50);
							continue;
						}
						entries[j].resource = this._cacheSampler.getSampler(sampler, false, bindingInfo.hashCode, sampler.label);
					} else Logger.Error(`Sampler "${name}" not found in the material context. Make sure you bound it. entry=${JSON.stringify(entry)}, materialContext=${JSON.stringify(materialContext, (key, value) => key === "texture" || key === "sampler" ? "<no dump>" : value)}`, 50);
					...
					} else Logger.Error(`Texture "${name}" not found in the material context. Make sure you bound it (something like effect.setTexture("${name}", texture)). entry=${JSON.stringify(entry)}, materialContext=${JSON.stringify(materialContext, (key, value) => key === "texture" || key === "sampler" ? "<no dump>" : value)}`, 50);
					...
					} else Logger.Error(`External texture "${name}" not found in the material context. Make sure you bound it. entry=${JSON.stringify(entry)}, materialContext=${JSON.stringify(materialContext, (key, value) => key === "texture" || key === "sampler" ? "<no dump>" : value)}`, 50);
					...
					} else Logger.Error(`Can't find buffer "${name}" in the draw context. Make sure you bound it. entry=${JSON.stringify(entry)}, buffers=${JSON.stringify(drawContext.buffers)}, drawContext.uniqueId=${drawContext.uniqueId}`, 50);
				}
			}
...
WebGPUCacheBindGroups._NumBindGroupsNoLookupCurrentFrame = 0;
//#endregion
//#region node_modules/@babylonjs/core/ShadersWGSL/clearQuad.vertex.js
var name$1 = "clearQuadVertexShader";
var shader$1 = `uniform depthValue: f32;const pos=array(
vec2f(-1.0,1.0),
vec2f(1.0,1.0),
vec2f(-1.0,-1.0),
vec2f(1.0,-1.0)
...
`;
if (!ShaderStore.ShadersStoreWGSL[name$1]) ShaderStore.ShadersStoreWGSL[name$1] = shader$1;
//#endregion
//#region node_modules/@babylonjs/core/ShadersWGSL/clearQuad.fragment.js
var name = "clearQuadPixelShader";
var shader = `uniform color: vec4f;@fragment
...
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGPU/webgpuClearQuad.js
/** @internal */
var WebGPUClearQuad = class {
	...
	constructor(device, engine, emptyVertexBuffer) {
		...
		this._effect = engine.createEffect("clearQuad", [], ["color", "depthValue"], void 0, void 0, void 0, void 0, void 0, void 0, 1);
	}
	clear(renderPass, clearColor, clearDepth, clearStencil, sampleCount = 1) {
		...
		if (renderPass) renderPass2 = renderPass;
		else {
			let idx = 0;
			this._keyTemp.length = 0;
			for (let i = 0; i < this._cacheRenderPipeline.colorFormats.length; ++i) this._keyTemp[idx++] = renderableTextureFormatToIndex[this._cacheRenderPipeline.colorFormats[i] ?? ""];
		...
		if (clearColor) this._effect.setDirectColor4("color", clearColor);
		...
		if (!bindGroups) {
			...
			if (!WebGPUShaderProcessingContext._SimplifiedKnownBindings) bindGroups.push(this._device.createBindGroup({
		...
		for (let i = 0; i < bindGroups.length; ++i) renderPass2.setBindGroup(i, bindGroups[i]);
...
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGPU/webgpuBundleList.js
/** @internal */
var WebGPURenderItemViewport = class WebGPURenderItemViewport {
	constructor(x, y, w, h) {
		this.x = Math.floor(x);
		this.y = Math.floor(y);
		this.w = Math.floor(w);
...
/** @internal */
var WebGPURenderItemScissor = class WebGPURenderItemScissor {
	constructor(x, y, w, h) {
		this.x = x;
		this.y = y;
		this.w = w;
...
/** @internal */
var WebGPURenderItemStencilRef = class WebGPURenderItemStencilRef {
	constructor(ref) {
		this.ref = ref;
	}
	run(renderPass) {
...
/** @internal */
var WebGPURenderItemBlendColor = class WebGPURenderItemBlendColor {
	constructor(color) {
		this.color = color;
	}
	run(renderPass) {
...
/** @internal */
var WebGPURenderItemBeginOcclusionQuery = class WebGPURenderItemBeginOcclusionQuery {
	constructor(query) {
		this.query = query;
	}
	run(renderPass) {
...
/** @internal */
var WebGPURenderItemEndOcclusionQuery = class WebGPURenderItemEndOcclusionQuery {
	constructor() {}
	run(renderPass) {
...
var WebGPURenderItemBundles = class WebGPURenderItemBundles {
	constructor() {
		this.bundles = [];
	}
	run(renderPass) {
...
/** @internal */
var WebGPUBundleList = class WebGPUBundleList {
	constructor(device) {
		this.numDrawCalls = 0;
		this._device = device;
	...
	addBundle(bundle) {
		...
		if (bundle) this._currentBundleList.push(bundle);
	}
	_finishBundle() {
	...
	run(renderPass) {
		this.close();
		for (let i = 0; i < this._listLength; ++i) this._list[i].run(renderPass);
	}
	reset() {
		this._listLength = 0;
		this._currentItemIsBundle = false;
	...
	clone() {
		...
		for (let i = 0; i < this._listLength; ++i) cloned._list[i] = this._list[i].clone();
		return cloned;
	}
};
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGPU/webgpuQuerySet.js
/** @internal */
var WebGPUQuerySet = class {
	...
	constructor(engine, count, type, device, bufferManager, canUseMultipleBuffers = true, label) {
		...
		if (!canUseMultipleBuffers) this._dstBuffers.push(this._bufferManager.createRawBuffer(8 * this._count, BufferUsage.MapRead | BufferUsage.CopyDst, void 0, "QueryBufferNoMultipleBuffers"));
	}
	_getBuffer(firstQuery, queryCount) {
		if (!this._canUseMultipleBuffers && this._dstBuffers.length === 0) return null;
		const encoderResult = this._device.createCommandEncoder();
		let buffer;
		if (this._dstBuffers.length === 0) buffer = this._bufferManager.createRawBuffer(8 * this._count, BufferUsage.MapRead | BufferUsage.CopyDst, void 0, "QueryBufferAdditionalBuffer");
		else {
	...
	async readValues(firstQuery = 0, queryCount = 1) {
		...
		try {
			...
			if (this._engine.isDisposed || this._engine.uniqueId !== engineId) return null;
			throw err;
		}
	}
	async readValue(firstQuery = 0) {
		...
		try {
			...
			if (this._engine.isDisposed || this._engine.uniqueId !== engineId) return 0;
			throw err;
		}
	}
	...
	dispose() {
		...
		for (let i = 0; i < this._dstBuffers.length; ++i) this._bufferManager.releaseBuffer(this._dstBuffers[i]);
	}
};
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGPU/webgpuTimestampQuery.js
/** @internal */
var WebGPUTimestampQuery = class {
	...
	set enable(value) {
		...
		else this._measureDuration.dispose();
	}
	...
	startPass(descriptor, index) {
		if (this._enabled) this._measureDuration.startPass(descriptor, index);
		else descriptor.timestampWrites = void 0;
	}
	endPass(index, gpuPerfCounter) {
		if (!this._enabled || !gpuPerfCounter) return;
...
var WebGPUDurationMeasure = class {
	...
	startPass(descriptor, index) {
		if (index + 3 > this._count) throw new Error("WebGPUDurationMeasure: index out of range (" + index + ")");
...
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGPU/webgpuOcclusionQuery.js
/** @internal */
var WebGPUOcclusionQuery = class {
	...
	canBeginQuery(index) {
		if (this._frameQuerySetIsDirty === this._engine.frameId || this._queryFrameId[index] === this._engine.frameId) return false;
		const canBegin = this._engine._getCurrentRenderPassWrapper().renderPassDescriptor.occlusionQuerySet !== void 0;
		if (canBegin) this._queryFrameId[index] = this._engine.frameId;
		return canBegin;
	}
	...
	createQuery() {
		if (this._availableIndices.length === 0) this._allocateNewIndices();
	...
	_retrieveQueryBuffer() {
		if (this._lastBuffer && this._frameLastBuffer === this._engine.frameId) return;
	...
	_allocateNewIndices(numIndices) {
		...
		for (let i = 0; i < numIndices; ++i) this._availableIndices.push(this._currentTotalIndices + i);
	...
	_delayQuerySetDispose() {
		...
		if (querySet) setTimeout(() => querySet.dispose, 1e3);
	}
	dispose() {
		this._querySet?.dispose();
...
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGPU/webgpuTintWASM.js
/** @internal */
var WebGPUTintWASM = class WebGPUTintWASM {
	async initTwgsl(twgslOptions) {
		if (WebGPUTintWASM._Twgsl) return;
		...
		if (twgslOptions.jsPath && twgslOptions.wasmPath) await Tools.LoadBabylonScriptAsync(twgslOptions.jsPath);
		if (self.twgsl) {
...
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGPU/webgpuSnapshotRendering.js
/** @internal */
var WebGPUSnapshotRendering = class {
	...
	set mode(mode) {
		if (this._record) this._modeSaved = mode;
		else this._mode = mode;
	}
	endRenderPass(currentRenderPass) {
		if (!this._record && !this._play) return false;
		let bundleList = null;
		if (this._record) {
		...
		} else if (this._playBundleListIndex >= this._allBundleLists.length) this._log("endRenderPass", `empty or out-of-sync bundleList (_allBundleLists.length=${this._allBundleLists.length}, playBundleListIndex=${this._playBundleListIndex})`);
		else {
		...
		if (bundleList) {
			...
			if (this._mode === 1) this._engine._reportDrawCall(bundleList.numDrawCalls);
		}
		return true;
	}
	endFrame() {
	...
	reset() {
		...
		if (this._record) this._mode = this._modeSaved;
		this.enabled = false;
		this.enabled = true;
	}
	_log(funcName, message) {
		if (this.showDebugLogs) Logger.Log(`[Frame: ${this._engine.frameId}] WebGPUSnapshotRendering:${funcName} - ${message}`);
	}
};
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGPU/webgpuExternalTexture.js
/**
...
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGPU/Extensions/engine.rawTexture.js
...
ThinWebGPUEngine.prototype.updateRawTexture = function(texture, bufferView, format, invertY, compression = null, type = 0, useSRGBBuffer = false, mipLevel) {
	...
	if (!this._doNotHandleContextLost) {
		...
		if (mipLevel !== void 0 && bufferView) {
			if (!texture._bufferViewArray) texture._bufferViewArray = new Array(texture.mipLevelCount);
			texture._bufferViewArray[mipLevel] = bufferView;
		}
	}
	if (bufferView) {
		const gpuTextureWrapper = texture._hardwareTexture;
		if (format === 4) bufferView = ConvertRGBtoRGBATextureData(bufferView, texture.width, texture.height, type);
		...
		if (texture.generateMipMaps && !mipLevel) this._generateMipmaps(texture, this._uploadEncoder);
	}
...
ThinWebGPUEngine.prototype.updateRawCubeTexture = function(texture, bufferView, _format, type, invertY, compression = null) {
	...
	for (let i = 0; i < bufferView.length; ++i) {
		...
		if (needConversion) faceData = ConvertRGBtoRGBATextureData(faceData, texture.width, texture.height, type);
	...
	if (texture.generateMipMaps) this._generateMipmaps(texture, this._uploadEncoder);
	texture.isReady = true;
};
ThinWebGPUEngine.prototype.createRawCubeTextureFromUrl = function(url, scene, size, format, type, noMipmap, callback, mipmapGenerator, onLoad = null, onError = null, samplingMode = 3, invertY = false) {
	...
	const internalCallbackAsync = async (data) => {
		...
		if (!faceDataArraysResult) return;
		...
		if (mipmapGenerator) {
			...
			for (let level = 0; level < mipData.length; level++) {
				...
				for (let faceIndex = 0; faceIndex < 6; faceIndex++) {
					...
					if (needConversion) mipFaceData = ConvertRGBtoRGBATextureData(mipFaceData, mipSize, mipSize, type);
...
ThinWebGPUEngine.prototype.createRawTexture3D = function(data, width, height, depth, format, generateMipMaps, invertY, samplingMode, compression = null, textureType = 0, creationFlags = 0) {
	const texture = new InternalTexture(this, 10);
	texture.baseWidth = width;
	texture.baseHeight = height;
...
ThinWebGPUEngine.prototype.updateRawTexture3D = function(texture, bufferView, format, invertY, compression = null, textureType = 0) {
	...
	if (bufferView) {
		const gpuTextureWrapper = texture._hardwareTexture;
		if (format === 4) bufferView = ConvertRGBtoRGBATextureData(bufferView, texture.width, texture.height, textureType);
		const data = new Uint8Array(bufferView.buffer, bufferView.byteOffset, bufferView.byteLength);
...
ThinWebGPUEngine.prototype.createRawTexture2DArray = function(data, width, height, depth, format, generateMipMaps, invertY, samplingMode, compression = null, textureType = 0, creationFlags = 0, mipLevelCount) {
	const texture = new InternalTexture(this, 11);
	texture.baseWidth = width;
	texture.baseHeight = height;
	texture.baseDepth = depth;
	texture.width = width;
...
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGPU/Extensions/engine.readTexture.js
...
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGPU/Extensions/engine.cubeTexture.js
ThinWebGPUEngine.prototype._createDepthStencilCubeTexture = function(size, options) {
	const internalTexture = new InternalTexture(this, options.generateStencil ? 12 : 14);
...
ThinWebGPUEngine.prototype.createCubeTexture = function(rootUrl, scene, files, noMipmap, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = false, lodScale = 0, lodOffset = 0, fallback = null, loaderOptions, useSRGBBuffer = false, buffer = null) {
	return this.createCubeTextureBase(rootUrl, scene, files, !!noMipmap, onLoad, onError, format, forcedExtension, createPolynomials, lodScale, lodOffset, fallback, null, (texture, imgs) => {
		...
		if (!noMipmap) this._generateMipmaps(texture, this._uploadEncoder);
		texture.isReady = true;
...
ThinWebGPUEngine.prototype._setCubeMapTextureParams = function(texture, loadMipmap, maxLevel) {
	...
	texture._cachedWrapU = 0;
	texture._cachedWrapV = 0;
	if (maxLevel) texture._maxLodLevel = maxLevel;
};
ThinWebGPUEngine.prototype.generateMipMapsForCubemap = function(texture) {
	if (texture.generateMipMaps) {
		if (!texture._hardwareTexture?.underlyingResource) this._textureHelper.createGPUTextureForInternalTexture(texture);
		this._generateMipmaps(texture);
	}
};
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGPU/webgpuRenderTargetWrapper.js
/**
...
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGPU/Extensions/engine.renderTarget.js
...
ThinWebGPUEngine.prototype.createRenderTargetTexture = function(size, options) {
	...
	const texture = fullOptions.colorAttachment || (fullOptions.noColorAttachment ? null : this._createInternalTexture(size, fullOptions, true, 5));
	...
	if (rtWrapper._generateDepthBuffer || rtWrapper._generateStencilBuffer) rtWrapper.createDepthStencilTexture(0, false, rtWrapper._generateStencilBuffer, rtWrapper.samples, fullOptions.generateStencilBuffer ? 13 : 14, fullOptions.label ? fullOptions.label + "-DepthStencil" : void 0);
	if (texture && !fullOptions.colorAttachment) {
		if (options !== void 0 && typeof options === "object" && options.createMipMaps && !fullOptions.generateMipMaps) texture.generateMipMaps = true;
		this._textureHelper.createGPUTextureForInternalTexture(texture, void 0, void 0, void 0, fullOptions.creationFlags);
		if (options !== void 0 && typeof options === "object" && options.createMipMaps && !fullOptions.generateMipMaps) texture.generateMipMaps = false;
	}
	return rtWrapper;
};
ThinWebGPUEngine.prototype._createDepthStencilTexture = function(size, options, wrapper) {
	...
	const internalTexture = new InternalTexture(this, hasStencil ? 12 : 14);
	internalTexture.label = options.label;
	internalTexture.format = internalOptions.depthTextureFormat;
...
ThinWebGPUEngine.prototype.updateRenderTargetTextureSampleCount = function(rtWrapper, samples) {
	if (!rtWrapper || !rtWrapper.texture || rtWrapper.samples === samples) return samples;
	samples = Math.min(samples, this.getCaps().maxMSAASamples);
	rtWrapper.texture._hardwareTexture?.releaseMSAATextures();
...
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGPU/Extensions/engine.renderTargetTexture.js
...
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGPU/Extensions/engine.renderTargetCube.js
ThinWebGPUEngine.prototype.createRenderTargetCubeTexture = function(size, options) {
	...
	this._internalTexturesCache.push(texture);
	rtWrapper.setTextures(texture);
	if (rtWrapper._generateDepthBuffer || rtWrapper._generateStencilBuffer) rtWrapper.createDepthStencilTexture(0, fullOptions.samplingMode === void 0 || fullOptions.samplingMode === 2 || fullOptions.samplingMode === 2 || fullOptions.samplingMode === 3 || fullOptions.samplingMode === 3 || fullOptions.samplingMode === 5 || fullOptions.samplingMode === 6 || fullOptions.samplingMode === 7 || fullOptions.samplingMode === 11, rtWrapper._generateStencilBuffer, rtWrapper.samples);
	if (options && options.createMipMaps && !fullOptions.generateMipMaps) texture.generateMipMaps = true;
	this._textureHelper.createGPUTextureForInternalTexture(texture);
	if (options && options.createMipMaps && !fullOptions.generateMipMaps) texture.generateMipMaps = false;
	return rtWrapper;
};
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGPU/Extensions/engine.query.js
...
ThinWebGPUEngine.prototype.endOcclusionQuery = function() {
	if (this.compatibilityMode) this._currentRenderPass?.endOcclusionQuery();
	else this._bundleList.addItem(new WebGPURenderItemEndOcclusionQuery());
	return this;
};
//#endregion
//#region node_modules/@babylonjs/core/Engines/webgpuEngine.js
...
* @since 5.0.0
*/
var WebGPUEngine = class WebGPUEngine extends ThinWebGPUEngine {
	/**
	...
	*/
	...
	set disableCacheSamplers(disable) {
		if (this._cacheSampler) this._cacheSampler.disabled = disable;
	}
	/**
	...
	*/
	...
	set disableCacheRenderPipelines(disable) {
		if (this._cacheRenderPipeline) this._cacheRenderPipeline.disabled = disable;
	}
	/**
	...
	*/
	...
	set disableCacheBindGroups(disable) {
		if (this._cacheBindGroups) this._cacheBindGroups.disabled = disable;
	}
	/**
	...
	*/
	constructor(canvas, options = {}) {
		...
		*/
		...
		if (navigator && navigator.userAgent) this._setupMobileChecks();
	...
	*/
	prepareGlslangAndTintAsync() {
		if (!this._workingGlslangAndTintPromise) this._workingGlslangAndTintPromise = new Promise((resolve) => {
	...
	*/
	initAsync(glslangOptions, twgslOptions) {
		...
		return navigator.gpu.requestAdapter(this._options).then(async (adapter) => {
			if (!adapter) throw "Could not retrieve a WebGPU adapter (adapter is null or undefined).";
			else {
				...
				if (requiredFeatures) {
					...
					for (const extension of requestedExtensions) if (this._adapterSupportedExtensions.indexOf(extension) !== -1) validExtensions.push(extension);
				...
				if (this._options.setMaximumLimits && !deviceDescriptor.requiredLimits) {
					...
					for (const name in this._adapterSupportedLimits) {
						if (name === "minSubgroupSize" || name === "maxSubgroupSize") continue;
			...
			this._device.addEventListener("uncapturederror", (event) => {
				if (++numUncapturedErrors < this.numMaxUncapturedErrors) Logger.Warn(`[Frame ${this._frameId}] WebGPU uncaptured error (${numUncapturedErrors + 1}): ${event.error} - ${event.error.message}`);
				else if (numUncapturedErrors++ === this.numMaxUncapturedErrors) Logger.Warn(`[Frame ${this._frameId}] WebGPU uncaptured error: too many warnings (${this.numMaxUncapturedErrors}), no more warnings will be reported to the console for this engine.`);
			});
			if (!this._doNotHandleContextLost) this._device.lost?.then((info) => {
			...
			this._dummyIndexBuffer = this._bufferManager.createBuffer(new Uint16Array([
				...
				0,
				0
			]), BufferUsage.Storage | BufferUsage.CopyDst, "DummyIndices");
	...
	_initGlslangAsync(glslangOptions) {
		...
		if (glslangOptions.glslang) return glslangOptions.glslang;
		if (self.glslang) return self.glslang(glslangOptions.wasmPath);
		if (glslangOptions.jsPath && glslangOptions.wasmPath) return Tools.LoadBabylonScriptAsync(glslangOptions.jsPath).then(() => {
			return self.glslang(Tools.GetBabylonScriptURL(glslangOptions.wasmPath));
		});
		throw new Error("glslang is not available");
	}
	_initializeLimits() {
		const textureFormatsTier1 = this._deviceEnabledExtensions.indexOf("texture-formats-tier1") >= 0;
		this._caps = {
			...
			astc: this._deviceEnabledExtensions.indexOf("texture-compression-astc") >= 0 ? true : void 0,
			s3tc: this._deviceEnabledExtensions.indexOf("texture-compression-bc") >= 0 ? true : void 0,
			pvrtc: null,
			etc1: null,
			etc2: this._deviceEnabledExtensions.indexOf("texture-compression-etc2") >= 0 ? true : void 0,
			bptc: this._deviceEnabledExtensions.indexOf("texture-compression-bc") >= 0 ? true : void 0,
			maxAnisotropy: 16,
			uintIndices: true,
			fragmentDepthSupported: true,
			highPrecisionShaderSupported: true,
			colorBufferFloat: true,
			blendFloat: this._deviceEnabledExtensions.indexOf("float32-blendable") >= 0,
			supportFloatTexturesResolve: false,
			rg11b10ufColorRenderable: this._deviceEnabledExtensions.indexOf("rg11b10ufloat-renderable") >= 0,
			textureFloat: true,
			textureFloatLinearFiltering: this._deviceEnabledExtensions.indexOf("float32-filterable") >= 0,
			...
			timerQuery: typeof BigUint64Array !== "undefined" && this._deviceEnabledExtensions.indexOf("timestamp-query") !== -1 ? true : void 0,
			...
			dualSourceBlending: this._deviceEnabledExtensions.includes("dual-source-blending"),
	...
	_initializeContextAndSwapChain() {
		if (!this._renderingCanvas) throw "The rendering canvas has not been set!";
	...
	_initializeMainAttachments() {
		...
		if (this._options.antialias) {
			...
			if (this._mainTexture) this._textureHelper.releaseTexture(this._mainTexture);
		...
		if (this._depthTexture) this._textureHelper.releaseTexture(this._depthTexture);
	...
	*/
	...
	_rebuildBuffers() {
		...
		for (const storageBuffer of this._storageBuffers) if (storageBuffer.getBuffer().engineId !== this.uniqueId) storageBuffer._rebuild();
	}
	_restoreEngineAfterContextLost(initEngine) {
		...
		const cleanScenes = (scenes) => {
			for (const scene of scenes) {
				for (const mesh of scene.meshes) {
					...
					for (const subMesh of subMeshes) subMesh._drawWrappers = [];
				}
		...
		const uboList = [];
		for (const uniformBuffer of this._uniformBuffers) if (uniformBuffer.name.indexOf("leftOver") < 0) uboList.push(uniformBuffer);
	...
	*/
	setSize(width, height, forceSetSize = false) {
		if (!super.setSize(width, height, forceSetSize)) return false;
		this._initializeMainAttachments();
	...
	*/
	_getShaderProcessor(shaderLanguage) {
		if (shaderLanguage === 1) return this._shaderProcessorWGSL;
	...
	*/
	...
	_getCurrentRenderPass() {
		if (this._currentRenderTarget && !this._currentRenderPass) this._startRenderTargetRenderPass(this._currentRenderTarget, false, null, false, false);
		else if (!this._currentRenderPass) this._startMainRenderPass(false);
	...
	*/
	...
	_applyViewport(bundleList) {
		...
		if (!this._currentRenderTarget) y = this.getRenderHeight(true) - y - h;
		if (bundleList) bundleList.addItem(new WebGPURenderItemViewport(x, y, w, h));
		else this._getCurrentRenderPass().setViewport(x, y, w, h, 0, 1);
	}
	/**
	* @internal
	*/
	...
	_applyScissor(bundleList) {
		...
		if (bundleList) bundleList.addItem(new WebGPURenderItemScissor(this._scissorCached.x, y, this._scissorCached.z, this._scissorCached.w));
		else this._getCurrentRenderPass().setScissorRect(this._scissorCached.x, y, this._scissorCached.z, this._scissorCached.w);
	}
	_scissorIsActive() {
	...
	_mustUpdateStencilRef() {
		...
		if (update) this._stencilRefsCurrent = this._stencilStateComposer.funcRef;
		return update;
	}
	_applyStencilRef(bundleList) {
		if (bundleList) bundleList.addItem(new WebGPURenderItemStencilRef(this._stencilStateComposer.funcRef ?? 0));
		else this._getCurrentRenderPass().setStencilReference(this._stencilStateComposer.funcRef ?? 0);
	}
	...
	_applyBlendColor(bundleList) {
		if (bundleList) bundleList.addItem(new WebGPURenderItemBlendColor(this._alphaState._blendConstants.slice()));
		else this._getCurrentRenderPass().setBlendConstant(this._alphaState._blendConstants);
	}
	...
	*/
	clear(color, backBuffer, depth, stencil = false, stencilClearValue = 0) {
		if (color && color.a === void 0) color.a = 1;
		if (stencil) this._clearStencilValue = stencilClearValue;
		const hasScissor = this._scissorIsActive();
		if (this._currentRenderTarget) if (hasScissor) {
			if (!this._currentRenderPass) this._startRenderTargetRenderPass(this._currentRenderTarget, false, backBuffer ? color : null, depth, stencil);
			this._applyScissor(!this.compatibilityMode ? this._bundleList : null);
			this._clearFullQuad(backBuffer ? color : null, depth, stencil);
		} else {
			if (this._currentRenderPass) this._endCurrentRenderPass();
			this._startRenderTargetRenderPass(this._currentRenderTarget, true, backBuffer ? color : null, depth, stencil);
		}
		else {
			if (!this._currentRenderPass || !hasScissor) this._startMainRenderPass(!hasScissor, backBuffer ? color : null, depth, stencil);
			if (hasScissor) {
				this._applyScissor(!this.compatibilityMode ? this._bundleList : null);
				this._clearFullQuad(backBuffer ? color : null, depth, stencil);
			}
	...
	_clearFullQuad(clearColor, clearDepth, clearStencil) {
		...
		if (!this.compatibilityMode) this._bundleList.addItem(new WebGPURenderItemStencilRef(this._clearStencilValue));
		else renderPass.setStencilReference(this._clearStencilValue);
		...
		} else this._applyStencilRef(null);
	}
	/**
	...
	*/
	createVertexBuffer(data, _updatable, label) {
		let view;
		if (data instanceof Array) view = new Float32Array(data);
		else if (ArrayBuffer.isView(data)) view = data;
		else view = new Uint8Array(data);
		return this._bufferManager.createBuffer(view, BufferUsage.Vertex | BufferUsage.CopyDst | BufferUsage.Storage, label);
	}
	/**
	* Creates a vertex buffer
	...
	*/
	createIndexBuffer(indices, _updatable, label) {
		let is32Bits = true;
		let view;
		if (indices instanceof Uint32Array || indices instanceof Int32Array) view = indices;
		else if (indices instanceof Uint16Array) {
			view = indices;
			is32Bits = false;
		} else {
			for (let index = 0; index < indices.length; index++) if (indices[index] > 65535) {
	...
	*/
	updateDynamicVertexBuffer(vertexBuffer, data, byteOffset, byteLength) {
		...
		} else if (data instanceof Array) view = new Float32Array(data);
		else if (ArrayBuffer.isView(data)) view = data;
		else view = new Uint8Array(data);
	...
	*/
	_createBuffer(data, creationFlags, label) {
		...
		let flags = 0;
		if (creationFlags & 1) flags |= BufferUsage.CopySrc;
		if (creationFlags & 2) flags |= BufferUsage.CopyDst;
		if (creationFlags & 4) flags |= BufferUsage.Uniform;
		if (creationFlags & 8) flags |= BufferUsage.Vertex;
		if (creationFlags & 16) flags |= BufferUsage.Index;
		if (creationFlags & 32) flags |= BufferUsage.Storage;
		if (creationFlags & 64) flags |= BufferUsage.Indirect;
	...
	*/
	createUniformBuffer(elements, label) {
		let view;
		if (elements instanceof Array) view = new Float32Array(elements);
		else view = elements;
		return this._bufferManager.createBuffer(view, BufferUsage.Uniform | BufferUsage.CopyDst, label);
	}
	/**
	...
	*/
	updateUniformBuffer(uniformBuffer, elements, offset, count) {
		...
		let view;
		if (count === void 0) {
			if (elements instanceof Float32Array) view = elements;
			else view = new Float32Array(elements);
			count = view.byteLength;
		} else if (elements instanceof Float32Array) view = elements;
		else view = new Float32Array(elements);
	...
	*/
	...
	_getWGSLShader(source, type, defines) {
		if (defines) defines = "//" + defines.split("\n").join("\n//") + "\n";
		else defines = "";
	...
	*/
	async _preparePipelineContextAsync(pipelineContext, vertexSourceCode, fragmentSourceCode, createAsRaw, rawVertexSourceCode, rawFragmentSourceCode, _rebuildRebind, defines, _transformFeedbackVaryings, _key, onReady) {
		...
		if (shaderLanguage === 0 && !this._glslangAndTintAreFullyLoaded) await this.prepareGlslangAndTintAsync();
		...
		if (createAsRaw) webGpuContext.stages = this._compileRawPipelineStageDescriptor(vertexSourceCode, fragmentSourceCode, shaderLanguage);
		else webGpuContext.stages = this._compilePipelineStageDescriptor(vertexSourceCode, fragmentSourceCode, defines, shaderLanguage);
		onReady();
	}
	/**
	...
	*/
	getAttributes(pipelineContext, attributesNames) {
		...
		for (let i = 0; i < attributesNames.length; i++) {
			...
			if (attributeLocation === void 0) continue;
	...
	*/
	enableEffect(effect) {
		...
		if (!IsWrapper(effect)) {
			...
			if (this.dbgLogIfNotDrawWrapper) Logger.Warn(`enableEffect has been called with an Effect and not a Wrapper! effect.uniqueId=${effect.uniqueId}, effect.name=${effect.name}, effect.name.vertex=${typeof effect.name === "string" ? "" : effect.name.vertex}, effect.name.fragment=${typeof effect.name === "string" ? "" : effect.name.fragment}`, 10);
		...
		this._forceEnableEffect = false;
		if (this._currentEffect.onBind) this._currentEffect.onBind(this._currentEffect);
		if (this._currentEffect._onBindObservable) this._currentEffect._onBindObservable.notifyObservers(this._currentEffect);
	}
	/**
	* @internal
	*/
	...
	*/
	...
	_deletePipelineContext(pipelineContext) {
		...
		if (webgpuPipelineContext) resetCachedPipeline(webgpuPipelineContext);
	}
	/**
		...
		return this._createTextureBase(url, noMipmap, invertY, scene, samplingMode, onLoad, onError, (texture, extension, scene, img, invertY, noMipmap, isCompressed, processFunction) => {
			...
			if (!texture._hardwareTexture?.underlyingResource) {
				...
				if (WebGPUTextureHelper.IsImageBitmap(imageBitmap)) {
					...
					if (!noMipmap && !isCompressed) this._generateMipmaps(texture, this._uploadEncoder);
				}
			} else if (!noMipmap && !isCompressed) this._generateMipmaps(texture, this._uploadEncoder);
	...
	*/
	updateTextureWrappingMode(texture, wrapU, wrapV = null, wrapR = null) {
		if (wrapU !== null) texture._cachedWrapU = wrapU;
		if (wrapV !== null) texture._cachedWrapV = wrapV;
		if ((texture.is2DArray || texture.is3D) && wrapR !== null) texture._cachedWrapR = wrapR;
	}
	/**
	...
	*/
	updateTextureDimensions(texture, width, height, depth = 1) {
		...
		if (texture.width === width && texture.height === height && texture.depth === depth) return;
	...
	*/
	_setInternalTexture(name, texture, baseName) {
		...
		if (this._currentEffect) {
			const availableTexture = this._currentEffect._pipelineContext.shaderProcessingContext.availableTextures[baseName];
	...
	*/
	createPrefilteredCubeTexture(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
		const callback = (loadData) => {
			...
			if (!createPolynomials) texture._sphericalPolynomial = texture._sphericalPolynomial ?? new SphericalPolynomial();
	...
	*/
	setTextureArray(channel, unused, textures, name) {
		for (let index = 0; index < textures.length; index++) this._setTexture(-1, textures[index], true, false, name + index.toString(), name);
	}
	/**
	* @internal
	*/
	_setTexture(channel, texture, isPartOfTextureArray = false, depthStencilTexture = false, name = "", baseName) {
		...
		if (this._currentEffect) {
			...
			if (texture.video) texture.update();
	...
	*/
	_setAnisotropicLevel(target, internalTexture, anisotropicFilteringLevel) {
		if (internalTexture._cachedAnisotropicFilteringLevel !== anisotropicFilteringLevel) internalTexture._cachedAnisotropicFilteringLevel = Math.min(anisotropicFilteringLevel, this._caps.maxAnisotropy);
	}
	/**
	* @internal
	*/
	...
	*/
	updateTextureData(texture, imageData, xOffset, yOffset, width, height, faceIndex = 0, lod = 0, generateMipMaps = false) {
		...
		if (!texture._hardwareTexture?.underlyingResource) gpuTextureWrapper = this._textureHelper.createGPUTextureForInternalTexture(texture);
		...
		if (generateMipMaps) this._generateMipmaps(texture);
	}
	/**
	* @internal
	*/
	...
	*/
	_uploadDataToTextureDirectly(texture, imageData, faceIndex = 0, lod = 0, babylonInternalFormat, useTextureWidthAndHeight = false) {
		...
		let gpuTextureWrapper = texture._hardwareTexture;
		if (!texture._hardwareTexture?.underlyingResource) gpuTextureWrapper = this._textureHelper.createGPUTextureForInternalTexture(texture, width, height);
		const data = new Uint8Array(imageData.buffer, imageData.byteOffset, imageData.byteLength);
	...
	*/
	_uploadImageToTexture(texture, image, faceIndex = 0, lod = 0) {
		let gpuTextureWrapper = texture._hardwareTexture;
		if (!texture._hardwareTexture?.underlyingResource) gpuTextureWrapper = this._textureHelper.createGPUTextureForInternalTexture(texture);
		if (image instanceof HTMLImageElement) throw "WebGPU engine: HTMLImageElement not supported in _uploadImageToTexture!";
		const bitmap = image;
	...
	*/
	readPixels(x, y, width, height, _hasAlpha = true, flushRenderer = true, data = null) {
		const hardwareTexture = this._getCurrentRenderPassWrapper().colorAttachmentGPUTextures[0];
		if (!hardwareTexture) return Promise.resolve(new Uint8Array(0));
		const gpuTexture = hardwareTexture.underlyingResource;
		const gpuTextureFormat = hardwareTexture.format;
		if (!gpuTexture) return Promise.resolve(new Uint8Array(0));
		if (flushRenderer) this.flushFramebuffer();
	...
	*/
	flushFramebuffer(_fromEndFrame = false) {
		...
		} else this._debugPushAfterStartOfEncoder();
	...
	_startRenderTargetRenderPass(renderTargetWrapper, setClearStates, clearColor, clearDepth, clearStencil) {
		...
		if (!depthStencilView && gpuDepthStencilTexture) depthStencilView = gpuDepthStencilTexture.createView(this._rttRenderPassWrapper.depthAttachmentViewDescriptor);
		if (!format && gpuDepthStencilWrapper) format = gpuDepthStencilWrapper.format;
		...
		if (rtWrapper._attachments && rtWrapper.isMulti) {
			if (!this._mrtAttachments || this._mrtAttachments.length === 0) this._mrtAttachments = rtWrapper._defaultAttachments;
			...
			} else colorAttachments.push(null);
		}
		const frameCounter = this._internalFrameCounter++;
		...
		if (!gpuDepthStencilWrapper || !WebGPUTextureHelper.HasStencilAspect(gpuDepthStencilWrapper.format)) this._stencilStateComposer.enabled = false;
	}
	...
	*/
	bindFramebuffer(texture, faceIndex = 0, requiredWidth, requiredHeight, forceFullscreenViewport, lodLevel = 0, layer = 0) {
		...
		if (this._snapshotRendering.play || this._snapshotRendering.record) this._startRenderTargetRenderPass(this._currentRenderTarget, false, null, false, false);
	...
	*/
	unBindFramebuffer(texture, disableGenerateMipMaps = false, onBeforeUnbind) {
		...
		if (onBeforeUnbind) onBeforeUnbind();
	...
	_resolveAndGenerateMipMapsFramebuffer(texture, disableGenerateMipMaps = false) {
		if (!texture.disableAutomaticMSAAResolve) this.resolveFramebuffer(texture, false);
	...
	*/
	generateMipMapsFramebuffer(texture) {
		if (!texture.isMulti && texture.texture?.generateMipMaps && !texture.isCube) this._generateMipmaps(texture.texture);
	}
	/**
	...
	*/
	...
	restoreDefaultFramebuffer(unbindOnly) {
		if (this._currentRenderTarget) this.unBindFramebuffer(this._currentRenderTarget);
		else if (!this._currentRenderPass && !unbindOnly) this._startMainRenderPass(false);
		else this._endCurrentRenderPass();
	...
	*/
	_setColorFormat(wrapper) {
		...
		this._cacheRenderPipeline.setColorFormat(format);
		if (this._colorFormat === format) return;
	...
	*/
	_setDepthTextureFormat(wrapper) {
		...
		if (this._depthTextureFormat === wrapper.depthTextureFormat) return;
	...
	*/
	...
	_applyRenderPassChanges(bundleList) {
		...
		if (this._mustUpdateViewport()) this._applyViewport(bundleList);
		if (this._mustUpdateScissor()) this._applyScissor(bundleList);
		if (mustUpdateStencilRef) this._applyStencilRef(bundleList);
		if (mustUpdateBlendColor) this._applyBlendColor(bundleList);
	}
	_draw(drawType, fillMode, start, count, instancesCount) {
		...
		if (!this.compatibilityMode && (this._currentDrawContext.isDirty(this._currentMaterialContext.updateId) || this._currentMaterialContext.isDirty || this._currentMaterialContext.forceBindGroupCreation)) this._currentDrawContext.fastBundle = void 0;
		...
		if (useFastPath || this._snapshotRendering.record) {
			...
			if (!this._snapshotRendering.record) {
				...
				if (this._currentDrawContext.indirectDrawBuffer) this._currentDrawContext.setIndirectData(count, instancesCount || 1, start);
		...
		if (this._currentMaterialContext.hasFloatOrDepthTextures) {
			...
			for (let i = 0; i < webgpuPipelineContext.shaderProcessingContext.textureNames.length; ++i) {
				...
				if (texture?.type === 1 && !this._caps.textureFloatLinearFiltering || textureIsDepth) textureState |= bitVal;
				bitVal = bitVal << 1;
			}
		}
		...
		renderPass2.setPipeline(pipeline);
		if (this._currentIndexBuffer) renderPass2.setIndexBuffer(this._currentIndexBuffer.underlyingResource, this._currentIndexBuffer.is32Bits ? "uint32" : "uint16", 0);
		...
		for (let index = 0; index < vertexBuffers.length; index++) {
			...
			const buffer = vertexBuffer.effectiveBuffer;
			if (buffer) renderPass2.setVertexBuffer(index, buffer.underlyingResource, vertexBuffer._validOffsetRange ? 0 : vertexBuffer.byteOffset);
		}
		for (let i = 0; i < bindGroups.length; i++) renderPass2.setBindGroup(i, bindGroups[i]);
		...
		if ((nonCompatMode || this._currentDrawContext._enableIndirectDrawInCompatMode) && this._currentDrawContext.indirectDrawBuffer) {
			...
			if (drawType === 0) renderPass2.drawIndexedIndirect(this._currentDrawContext.indirectDrawBuffer, 0);
			else renderPass2.drawIndirect(this._currentDrawContext.indirectDrawBuffer, 0);
		} else if (drawType === 0) renderPass2.drawIndexed(count, instancesCount || 1, start, 0, 0);
		else renderPass2.draw(count, instancesCount || 1, start, 0);
		if (nonCompatMode) {
	...
	*/
	createRenderPipelineAsync(options) {
		if ("vertex" in options) return [this._device.createRenderPipelineAsync(options)];
		...
		for (const entry of entries) {
			...
			if (!geometry) throw new Error("WebGPUEngine.createRenderPipelineAsync: mesh has no geometry to derive vertex/index buffers from.");
			cache.setBuffers(geometry.getVertexBuffers(), geometry.getIndexBuffer(), null);
			const alphaMode = entry.alphaMode ?? 0;
			if (alphaMode === 0) cache.setAlphaBlendEnabled([false], 0);
			else {
	...
	*/
	createExternalTexture(video) {
		return new WebGPUExternalTexture(video);
	}
	/**
		...
		return await new Promise((resolve, reject) => {
			const readFromBuffer = () => {
				gpuBuffer.mapAsync(1, 0, size).then(() => {
					...
					if (this.isDisposed) resolve(new Uint8Array());
					else reject(reason);
				});
			};
			if (noDelay) {
				this.flushFramebuffer();
				readFromBuffer();
			} else this.onEndFrameObservable.addOnce(() => {
				readFromBuffer();
			});
		});
	}
	...
	*/
	readFromMultipleStorageBuffers(storageBuffers, offset, size, buffer, noDelay) {
		...
		for (let i = 0; i < storageBuffers.length; i++) this._renderEncoder.copyBufferToBuffer(storageBuffers[i].underlyingResource, offset ?? 0, gpuBuffer, i * size, size);
...
//#endregion
//#region node_modules/@babylonjs/core/Engines/WebGPU/Extensions/engine.multiRender.js
var engine_multiRender_exports = /* @__PURE__ */ __exportAll({});
WebGPUEngine.prototype.unBindMultiColorAttachmentFramebuffer = function(rtWrapper, disableGenerateMipMaps = false, onBeforeUnbind) {
	if (onBeforeUnbind) onBeforeUnbind();
	this._endCurrentRenderPass();
	if (!rtWrapper.disableAutomaticMSAAResolve) this.resolveMultiFramebuffer(rtWrapper, false);
...
WebGPUEngine.prototype.createMultipleRenderTarget = function(size, options, initializeBuffers) {
	...
	if ((generateDepthBuffer || generateStencilBuffer || generateDepthTexture) && !dontCreateTextures) {
		if (!generateDepthTexture) if (generateDepthBuffer && generateStencilBuffer) depthTextureFormat = 13;
		else if (generateDepthBuffer) depthTextureFormat = 14;
		else depthTextureFormat = 19;
	...
	for (let i = 0; i < textureCount; i++) {
		...
		if (target === -1 || dontCreateTextures) continue;
		const texture = new InternalTexture(this, 6);
		textures[i] = texture;
		switch (target) {
			case 34067:
				texture.isCube = true;
		...
		this._internalTexturesCache.push(texture);
		if (mipmapsCreationOnly) texture.generateMipMaps = true;
		this._textureHelper.createGPUTextureForInternalTexture(texture, void 0, void 0, void 0, creationFlag);
		if (mipmapsCreationOnly) texture.generateMipMaps = false;
	}
	...
	if (!dontCreateTextures) this.updateMultipleRenderTargetTextureSampleCount(rtWrapper, samples);
	else rtWrapper._samples = samples;
	return rtWrapper;
};
WebGPUEngine.prototype.updateMultipleRenderTargetTextureSampleCount = function(rtWrapper, samples) {
	if (!rtWrapper || !rtWrapper.textures || rtWrapper.textures.length === 0 || rtWrapper.textures[0].samples === samples) return samples;
	const count = rtWrapper.textures.length;
	if (count === 0) return 1;
	samples = Math.min(samples, this.getCaps().maxMSAASamples);
	for (let i = 0; i < count; ++i) rtWrapper.textures[i]._hardwareTexture?.releaseMSAATextures();
	for (let i = 0; i < count; ++i) {
		const texture = rtWrapper.textures[i];
		texture.samples = samples;
	}
	if (rtWrapper._depthStencilTexture) rtWrapper._depthStencilTexture.samples = samples;
	rtWrapper._samples = samples;
	return samples;
};
WebGPUEngine.prototype.generateMipMapsMultiFramebuffer = function(texture) {
	const rtWrapper = texture;
	if (!rtWrapper.isMulti) return;
	const count = rtWrapper._attachments.length;
	for (let i = 0; i < count; i++) {
		const texture = rtWrapper.textures[i];
		if (texture.generateMipMaps && !texture.isCube && !texture.is3D) this._generateMipmaps(texture);
	}
};
...
WebGPUEngine.prototype.bindAttachments = function(attachments) {
	if (attachments.length === 0 || !this._currentRenderTarget) return;
	this._mrtAttachments = attachments;
	if (this._currentRenderPass) this._cacheRenderPipeline.setMRTAttachments(attachments);
};
WebGPUEngine.prototype.buildTextureLayout = function(textureStatus, backBufferLayout = false) {
	const result = [];
	if (backBufferLayout) result.push(1);
	else for (let i = 0; i < textureStatus.length; i++) if (textureStatus[i]) result.push(i + 1);
	else result.push(0);
	return result;
};
...
//#endregion
export { VertexFormat as $, FeatureName as A, CreateStreamingSoundAsync as At, QueryType as B, BoundingBox as Bt, ColorWrite as C, AudioEngineV2 as Ct, CullMode as D, CreateSoundAsync as Dt, ComputePassTimestampLocation as E, CreateMicrophoneSoundSourceAsync as Et, MapMode as F, VertexData as Ft, StorageTextureAccess as G, makeSyncFunction as Gt, SamplerBindingType as H, createYieldingScheduler as Ht, MipmapFilterMode as I, VertexDataMaterialInfo as It, TextureDimension as J, runCoroutineSync as Jt, StoreOp as K, runCoroutine as Kt, PipelineErrorReason as L, SubMesh as Lt, FrontFace as M, _GetAudioEngine as Mt, IndexFormat as N, AbstractMesh as Nt, DeviceLostReason as O, CreateSoundBufferAsync as Ot, LoadOp as P, _MeshCollisionData as Pt, TextureViewDimension as Q, PowerPreference as R, BoundingInfo as Rt, CanvasToneMappingMode as S, _SpatialAudioListenerDefaults as St, CompilationMessageType as T, CreateMainAudioBusAsync as Tt, ShaderStage as U, inlineScheduler as Ut, RenderPassTimestampLocation as V, IntersectionInfo as Vt, StencilOperation as W, makeAsyncFunction as Wt, TextureSampleType as X, TextureFormat as Y, TransformNode as Yt, TextureUsage as Z, BlendOperation as _, AudioEngine as _t, WebGPUCacheBindGroups as a, CreateImageBitmapFromSource as at, BufferUsage as b, AbstractSpatialAudioListener as bt, WebGPUCacheRenderPipelineTree as c, GetFontOffset as ct, WebGPUDataBuffer as d, ResizeImageBitmap as dt, VertexStepMode as et, WebGPUPipelineContext as f, _CommonDispose as ft, BlendFactor as g, RollingAverage as gt, AutoLayoutMode as h, PerformanceMonitor as ht, WebGPUTintWASM as i, InjectStartingAndEndingCode as it, FilterMode as j, LastCreatedAudioEngine as jt, ErrorFilter as k, CreateSoundSourceAsync as kt, WebGPUCacheRenderPipeline as l, RequestFullscreen as lt, AddressMode as m, RenderTargetWrapper as mt, WebGPUEngine as n, checkNonFloatVertexBuffers as nt, WebGPUDrawContext as o, ExitFullscreen as ot, WebGPUShaderProcessor as p, _CommonInit as pt, TextureAspect as q, runCoroutineAsync as qt, WebGPURenderTargetWrapper as r, ShaderCodeInliner as rt, ExternalTexture as s, ExitPointerlock as st, engine_multiRender_exports as t, _OcclusionDataStorage as tt, WebGPUCacheSampler as u, RequestPointerlock as ut, BufferBindingType as v, CreateAudioEngineAsync as vt, CompareFunction as w, CreateAudioBusAsync as wt, CanvasAlphaMode as x, _HasSpatialAudioListenerOptions as xt, BufferMapState as y, _WebAudioEngine as yt, PrimitiveTopology as z, BoundingSphere as zt };

//# sourceMappingURL=engine.multiRender-CM9hNAH_.js.map