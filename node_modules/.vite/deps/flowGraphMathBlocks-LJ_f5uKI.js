...
import { a as Vector3, i as Vector2, n as Quaternion, o as Vector4, t as Matrix } from "./math.vector-ivCpDlc6.js";
import { r as RegisterClass } from "./typeStore-Dy-yCYbL.js";
import { A as FlowGraphInteger, E as getRichTypeByFlowGraphType, O as FlowGraphMatrix2D, d as RichTypeBoolean, k as FlowGraphMatrix3D, m as RichTypeFlowGraphInteger, u as RichTypeAny, v as RichTypeNumber } from "./flowGraphBlock-BNLz85Bs.js";
import { i as _GetClassNameOf, n as _AreSameMatrixClass, o as getNumericValue, r as _AreSameVectorOrQuaternionClass, s as isNumeric, t as _AreSameIntegerClass } from "./utils-B1LyBAnv.js";
import { t as FlowGraphCachedOperationBlock } from "./flowGraphCachedOperationBlock-WAHP-Tru.js";
import { t as FlowGraphBinaryOperationBlock } from "./flowGraphBinaryOperationBlock-nLUHuzSW.js";
import { t as FlowGraphUnaryOperationBlock } from "./flowGraphUnaryOperationBlock-C8fpk9Vr.js";
...
var flowGraphMathBlocks_exports = /* @__PURE__ */ __exportAll({
	FlowGraphAbsBlock: () => FlowGraphAbsBlock,
	FlowGraphAcosBlock: () => FlowGraphAcosBlock,
	FlowGraphAcoshBlock: () => FlowGraphAcoshBlock,
	FlowGraphAddBlock: () => FlowGraphAddBlock,
	FlowGraphAsinBlock: () => FlowGraphAsinBlock,
	FlowGraphAsinhBlock: () => FlowGraphAsinhBlock,
	FlowGraphAtan2Block: () => FlowGraphAtan2Block,
	FlowGraphAtanBlock: () => FlowGraphAtanBlock,
	FlowGraphAtanhBlock: () => FlowGraphAtanhBlock,
	FlowGraphBitwiseAndBlock: () => FlowGraphBitwiseAndBlock,
	FlowGraphBitwiseLeftShiftBlock: () => FlowGraphBitwiseLeftShiftBlock,
	FlowGraphBitwiseNotBlock: () => FlowGraphBitwiseNotBlock,
	FlowGraphBitwiseOrBlock: () => FlowGraphBitwiseOrBlock,
	FlowGraphBitwiseRightShiftBlock: () => FlowGraphBitwiseRightShiftBlock,
	FlowGraphBitwiseXorBlock: () => FlowGraphBitwiseXorBlock,
	FlowGraphCeilBlock: () => FlowGraphCeilBlock,
	FlowGraphClampBlock: () => FlowGraphClampBlock,
	FlowGraphCosBlock: () => FlowGraphCosBlock,
	FlowGraphCoshBlock: () => FlowGraphCoshBlock,
	FlowGraphCubeRootBlock: () => FlowGraphCubeRootBlock,
	FlowGraphDegToRadBlock: () => FlowGraphDegToRadBlock,
	FlowGraphDivideBlock: () => FlowGraphDivideBlock,
	FlowGraphEBlock: () => FlowGraphEBlock,
	FlowGraphEqualityBlock: () => FlowGraphEqualityBlock,
	FlowGraphExpBlock: () => FlowGraphExpBlock,
	FlowGraphFloorBlock: () => FlowGraphFloorBlock,
	FlowGraphFractionBlock: () => FlowGraphFractionBlock,
	FlowGraphGreaterThanBlock: () => FlowGraphGreaterThanBlock,
	FlowGraphGreaterThanOrEqualBlock: () => FlowGraphGreaterThanOrEqualBlock,
	FlowGraphInfBlock: () => FlowGraphInfBlock,
	FlowGraphIsInfinityBlock: () => FlowGraphIsInfinityBlock,
	FlowGraphIsNanBlock: () => FlowGraphIsNanBlock,
	FlowGraphLeadingZerosBlock: () => FlowGraphLeadingZerosBlock,
	FlowGraphLessThanBlock: () => FlowGraphLessThanBlock,
	FlowGraphLessThanOrEqualBlock: () => FlowGraphLessThanOrEqualBlock,
	FlowGraphLog10Block: () => FlowGraphLog10Block,
	FlowGraphLog2Block: () => FlowGraphLog2Block,
	FlowGraphLogBlock: () => FlowGraphLogBlock,
	FlowGraphMathInterpolationBlock: () => FlowGraphMathInterpolationBlock,
	FlowGraphMaxBlock: () => FlowGraphMaxBlock,
	FlowGraphMinBlock: () => FlowGraphMinBlock,
	FlowGraphModuloBlock: () => FlowGraphModuloBlock,
	FlowGraphMultiplyBlock: () => FlowGraphMultiplyBlock,
	FlowGraphNaNBlock: () => FlowGraphNaNBlock,
	FlowGraphNegationBlock: () => FlowGraphNegationBlock,
	FlowGraphOneBitsCounterBlock: () => FlowGraphOneBitsCounterBlock,
	FlowGraphPiBlock: () => FlowGraphPiBlock,
	FlowGraphPowerBlock: () => FlowGraphPowerBlock,
	FlowGraphRadToDegBlock: () => FlowGraphRadToDegBlock,
	FlowGraphRandomBlock: () => FlowGraphRandomBlock,
	FlowGraphRoundBlock: () => FlowGraphRoundBlock,
	FlowGraphSaturateBlock: () => FlowGraphSaturateBlock,
	FlowGraphSignBlock: () => FlowGraphSignBlock,
	FlowGraphSinBlock: () => FlowGraphSinBlock,
	FlowGraphSinhBlock: () => FlowGraphSinhBlock,
	FlowGraphSquareRootBlock: () => FlowGraphSquareRootBlock,
	FlowGraphSubtractBlock: () => FlowGraphSubtractBlock,
	FlowGraphTanBlock: () => FlowGraphTanBlock,
	FlowGraphTanhBlock: () => FlowGraphTanhBlock,
	FlowGraphTrailingZerosBlock: () => FlowGraphTrailingZerosBlock,
	FlowGraphTruncBlock: () => FlowGraphTruncBlock
});
/**
...
var FlowGraphAddBlock = class extends FlowGraphBinaryOperationBlock {
	...
	*/
	...
	_polymorphicAdd(a, b) {
		...
		if (_AreSameVectorOrQuaternionClass(aClassName, bClassName) || _AreSameMatrixClass(aClassName, bClassName) || _AreSameIntegerClass(aClassName, bClassName)) return a.add(b);
		else if (aClassName === "Quaternion" || bClassName === "Vector4") return new Vector4(a.x, a.y, a.z, a.w).addInPlace(b);
		else if (aClassName === "Vector4" || bClassName === "Quaternion") return a.add(b);
		else {
			if (this.config?.preventIntegerFloatArithmetic && typeof a !== typeof b) throw new Error("Cannot add different types of numbers.");
...
var FlowGraphSubtractBlock = class extends FlowGraphBinaryOperationBlock {
	...
	*/
	...
	_polymorphicSubtract(a, b) {
		const aClassName = _GetClassNameOf(a);
		const bClassName = _GetClassNameOf(b);
		if (_AreSameVectorOrQuaternionClass(aClassName, bClassName) || _AreSameIntegerClass(aClassName, bClassName) || _AreSameMatrixClass(aClassName, bClassName)) return a.subtract(b);
		else if (aClassName === "Quaternion" || bClassName === "Vector4") return new Vector4(a.x, a.y, a.z, a.w).subtractInPlace(b);
		else if (aClassName === "Vector4" || bClassName === "Quaternion") return a.subtract(b);
		else {
			if (this.config?.preventIntegerFloatArithmetic && typeof a !== typeof b) throw new Error("Cannot add different types of numbers.");
			return getNumericValue(a) - getNumericValue(b);
		}
...
var FlowGraphMultiplyBlock = class extends FlowGraphBinaryOperationBlock {
	...
	_polymorphicMultiply(a, b) {
		const aClassName = _GetClassNameOf(a);
		const bClassName = _GetClassNameOf(b);
		if (_AreSameVectorOrQuaternionClass(aClassName, bClassName) || _AreSameIntegerClass(aClassName, bClassName)) return a.multiply(b);
		else if (aClassName === "Quaternion" || bClassName === "Vector4") return new Vector4(a.x, a.y, a.z, a.w).multiplyInPlace(b);
		else if (aClassName === "Vector4" || bClassName === "Quaternion") return a.multiply(b);
...
var FlowGraphDivideBlock = class extends FlowGraphBinaryOperationBlock {
	...
	*/
	...
	_polymorphicDivide(a, b) {
		const aClassName = _GetClassNameOf(a);
		const bClassName = _GetClassNameOf(b);
		if (_AreSameVectorOrQuaternionClass(aClassName, bClassName) || _AreSameIntegerClass(aClassName, bClassName)) return a.divide(b);
			...
			aClone.w /= b.w;
			return aClone;
		} else if (aClassName === "Quaternion" || bClassName === "Vector4") return new Vector4(a.x, a.y, a.z, a.w).divideInPlace(b);
		else if (aClassName === "Vector4" || bClassName === "Quaternion") return a.divide(b);
		else if (_AreSameMatrixClass(aClassName, bClassName)) if (this.config?.useMatrixPerComponent) {
			const aM = a.m;
			for (let i = 0; i < aM.length; i++) aM[i] /= b.m[i];
			if (aClassName === "Matrix2D") return new FlowGraphMatrix2D(aM);
...
function ComponentWiseBinaryOperation(a, b, op) {
	switch (_GetClassNameOf(a)) {
		...
		default: return op(getNumericValue(a), getNumericValue(b));
	}
}
/**
* Remainder block.
...
function ComponentWiseTernaryOperation(a, b, c, op) {
	switch (_GetClassNameOf(a)) {
		...
		default: return op(getNumericValue(a), getNumericValue(b), getNumericValue(c));
	}
}
/**
* Clamp block.
...
var FlowGraphEqualityBlock = class extends FlowGraphBinaryOperationBlock {
	...
	_polymorphicEq(a, b) {
		...
		if (_AreSameVectorOrQuaternionClass(aClassName, bClassName) || _AreSameMatrixClass(aClassName, bClassName) || _AreSameIntegerClass(aClassName, bClassName)) return a.equals(b);
		else return a === b;
	}
};
...
var FlowGraphIsNanBlock = class extends FlowGraphUnaryOperationBlock {
	...
	_polymorphicIsNan(a) {
		if (isNumeric(a, true)) return isNaN(getNumericValue(a));
