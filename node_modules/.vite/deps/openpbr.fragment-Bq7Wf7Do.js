...
import "./clipPlaneFragmentDeclaration-G9Lm62sT.js";
import "./logDepthDeclaration-DIVipkll.js";
import "./fogFragmentDeclaration-QYWTz1m0.js";
import "./logDepthFragment-DEbF3WD0.js";
import "./fogFragment-0dguHmsA.js";
import "./clipPlaneFragment-to8HHt97.js";
import "./helperFunctions-B5EQVHoR.js";
import "./samplerFragmentDeclaration-DKvUp5oL.js";
import "./pbrIBLFunctions-DBSAw-nA.js";
import "./sceneFragmentDeclaration-C2vcop6R.js";
import "./pbrBRDFFunctions-CUiqZtrW.js";
import "./openpbrTransmissionLayerData-Cl_YYRYF.js";
import "./reflectionFunction-BcOMJkOD.js";
import "./harmonicsFunctions-BdvuY8eq.js";
import "./imageProcessingDeclaration-uEK_jdm1.js";
import "./lightFragmentDeclaration-CkbpF9iJ.js";
import "./lightUboDeclaration-tI3fBBJE.js";
import "./shadowsFragmentFunctions-Dkbb6CeB.js";
import "./imageProcessingFunctions-C7KAMeFD.js";
import "./oitFragment-CchfXmJb.js";
import "./pbrDebug-CBCF7P3O.js";
import "./hdrFilteringFunctions-Cr9_uHUG.js";
import "./openpbrUboDeclaration-BkNAD4dZ.js";
//#region node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrFragmentDeclaration.js
var name$19 = "openpbrFragmentDeclaration";
var shader$19 = `uniform float vBaseWeight;uniform vec4 vBaseColor;uniform float vBaseDiffuseRoughness;uniform vec4 vReflectanceInfo;uniform vec4 vSpecularColor;uniform vec3 vSpecularAnisotropy;uniform float vTransmissionWeight;uniform vec3 vTransmissionColor;uniform float vTransmissionDepth;uniform vec3 vTransmissionScatter;uniform float vTransmissionScatterAnisotropy;uniform float vTransmissionDispersionScale;uniform float vTransmissionDispersionAbbeNumber;uniform float vSubsurfaceWeight;uniform vec3 vSubsurfaceColor;uniform float vSubsurfaceRadius;uniform vec3 vSubsurfaceRadiusScale;uniform float vSubsurfaceScatterAnisotropy;uniform float vCoatWeight;uniform vec3 vCoatColor;uniform float vCoatRoughness;uniform float vCoatRoughnessAnisotropy;uniform float vCoatIor;uniform float vCoatDarkening;uniform float vFuzzWeight;uniform vec3 vFuzzColor;uniform float vFuzzRoughness;uniform vec2 vGeometryCoatTangent;uniform float vGeometryThickness;uniform vec3 vEmissionColor;uniform float vThinFilmWeight;uniform vec2 vThinFilmThickness;uniform float vThinFilmIor;uniform float vGeometryThinWalled;uniform vec4 vLightingIntensity;uniform float visibility;uniform vec2 renderTargetSize;
#ifdef BASE_COLOR
...
//#endregion
//#region node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrFragmentSamplersDeclaration.js
var name$18 = "openpbrFragmentSamplersDeclaration";
var shader$18 = `#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
//#endregion
//#region node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrNormalMapFragmentMainFunctions.js
var name$17 = "openpbrNormalMapFragmentMainFunctions";
var shader$17 = `#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
//#endregion
//#region node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrNormalMapFragmentFunctions.js
var name$16 = "openpbrNormalMapFragmentFunctions";
var shader$16 = `#if defined(GEOMETRY_NORMAL)
...
//#endregion
//#region node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrConductorReflectance.js
var name$15 = "openpbrConductorReflectance";
var shader$15 = `#define pbr_inline
...
//#endregion
//#region node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrAmbientOcclusionFunctions.js
var name$14 = "openpbrAmbientOcclusionFunctions";
var shader$14 = `float compute_specular_occlusion(const float n_dot_v,const float metallic,const float ambient_occlusion,const float roughness)
...
//#endregion
//#region node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrVolumeFunctions.js
var name$13 = "openpbrVolumeFunctions";
var shader$13 = `struct OpenPBRHomogeneousVolume {vec3 extinction_coeff; 
vec3 ss_albedo; 
...
//#endregion
//#region node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrNormalMapFragment.js
var name$12 = "openpbrNormalMapFragment";
var shader$12 = `vec2 uvOffset=vec2(0.0,0.0);
...
//#endregion
//#region node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrBlockNormalFinal.js
var name$11 = "openpbrBlockNormalFinal";
var shader$11 = `#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
//#endregion
//#region node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrBaseLayerData.js
var name$10 = "openpbrBaseLayerData";
var shader$10 = `vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);float geometry_thickness=0.0;
#ifdef BASE_WEIGHT
...
//#endregion
//#region node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrCoatLayerData.js
var name$9 = "openpbrCoatLayerData";
var shader$9 = `float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
//#endregion
//#region node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrThinFilmLayerData.js
var name$8 = "openpbrThinFilmLayerData";
var shader$8 = `#ifdef THIN_FILM
...
//#endregion
//#region node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrFuzzLayerData.js
var name$7 = "openpbrFuzzLayerData";
var shader$7 = `float fuzz_weight=0.0;vec3 fuzz_color=vec3(1.0);float fuzz_roughness=0.0;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
//#endregion
//#region node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrAmbientOcclusionData.js
var name$6 = "openpbrAmbientOcclusionData";
var shader$6 = `vec3 ambient_occlusion=vec3(1.0);float specular_ambient_occlusion=1.0;float coat_specular_ambient_occlusion=1.0;
#ifdef AMBIENT_OCCLUSION
...
//#endregion
//#region node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrBackgroundTransmission.js
var name$5 = "openpbrBackgroundTransmission";
var shader$5 = `vec4 slab_translucent_background=vec4(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
//#endregion
//#region node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrEnvironmentLighting.js
var name$4 = "openpbrEnvironmentLighting";
var shader$4 = `#if defined(REFLECTION) || defined(REFRACTED_BACKGROUND)
...
//#endregion
//#region node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrDirectLightingInit.js
var name$3 = "openpbrDirectLightingInit";
...
//#endregion
//#region node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrDirectLighting.js
var name$2 = "openpbrDirectLighting";
var shader$2 = `#ifdef LIGHT{X}
...
//#endregion
//#region node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrBlockPrePass.js
var name$1 = "openpbrBlockPrePass";
var shader$1 = `#if SCENE_MRT_COUNT>0
...
//#endregion
//#region node_modules/@babylonjs/core/Shaders/openpbr.fragment.js
var openpbr_fragment_exports = /* @__PURE__ */ __exportAll({ openpbrPixelShader: () => openpbrPixelShader });
var name = "openpbrPixelShader";
var shader = `#define OPENPBR_FRAGMENT_SHADER
...
/** @internal */
var openpbrPixelShader = {
	name,
	shader
};
//#endregion
export { openpbr_fragment_exports as n, openpbrPixelShader as t };

//# sourceMappingURL=openpbr.fragment-Bq7Wf7Do.js.map